...
class University extends AppModel {
		...
		'name' => array(
			'notBlank' => array(
			 ...
			 'checkUnique' => array(
				    ...
				    'message' => 'The university name should be unique. 
  ...
  function getSectionUniversity($section_id) {
		...
		$section_detail = ClassRegistry::init('StudentsSection')->find('first',
			array(
				'conditions' =>
				array(
		...
		$student_detail = ClassRegistry::init('Student')->find('first',
			array(
				'conditions' =>
				array(
					'Student.id' => $section_detail['StudentsSection']['student_id']
				),
				'contain' =>
				array(
					'GraduateList'
	...
	function getAcceptedStudentUnivrsity($accepted_student_id = null) {
		$student_detail = ClassRegistry::init('AcceptedStudent')->find('first',
			array(
				'conditions' =>
				array(
