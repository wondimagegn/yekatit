...
?>
 	...
 	<div class="smallheading"><?php echo __('View Course Drops ');?></div>
 	<table cellspacing="0" cellpadding="0" class="fs14">
		...
		<tr>
		<td colspan='4'><?php echo $this->Form->submit(__('View Course Drops '), array('name' => 'viewCourseDrops','class'=>'tiny radius button bg-blue','div' => false)); ?></td>
		</tr>
</table>
<?php 
}
...
<div class="courseDrops index">
	<h2><?php echo __('Course Drops');?></h2>
	...
	<tr<?php echo $class;?>>
		...
		?>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $courseDrop['CourseDrop']['id'])); ?>
