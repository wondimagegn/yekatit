											...
											<tr>
												...
												<td class="center">
													...
													if ($role_id == ROLE_DEPARTMENT) { ?>
														...
														<?= $this->Html->link(__(''), array('action' => 'delete', $course['Course']['id']), array('class' => 'fontello-trash-1', 'title' => 'Delete'), sprintf(__('Are you sure you want to delete # %s?'), $course['Course']['id'])); ?>
														<?php
													} ?>
												</td>
											</tr>
