...
<table cellspacing="0" cellpadding="0" class="fs13">
	...
	<tr class="AttrationRateView" style="display:<?php echo $display; ?>">
		<td colspan="6">
		<?php echo $this->Form->submit(__('Get Report'), array('name' => 'getReport','class'=>'tiny radius button bg-blue', 'div' => false)); ?>
		</td>
	</tr>
</table>
...
?>
       ...
       <table style="width:100%">
            ...
            <tr>
		        ...
		        <th class="bordering2"  style="vertical-align:bottom; width:20%">Course</th>
                 <th class="bordering2"  style="vertical-align:bottom; width:8%">Section</th>
