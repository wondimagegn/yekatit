...
<div class="smallheading"><?php echo __('Top Student View'); ?></div>
...
?>
    <p class="fs16">
            Top <?php echo $this->request->data['Report']['top'].' '.$this->request->data['Report']['gender']; ?> students as of  <?php echo $this->request->data['Report']['acadamic_year']; ?> A/Y, 
