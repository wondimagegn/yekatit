...
<h2>Edit Fee Types for Category ID: <?php echo $category_id; ?></h2>
<?php echo $this->Form->create('FeeType', array('url' => array('action' => 'edit_category_fee_types', $category_id))); ?>
<table class="bulk-edit-table">
    ...
    <?php foreach ($feeTypes as $index => $feeType): ?>
        <tr>
            ...
            <td><input type="text" name="data[FeeType][<?php echo $index; ?>][year]" value="<?php echo h($feeType['FeeType']['year']); ?>"></td>
