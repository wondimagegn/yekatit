...
<div class="smallheading"><?php echo __('Submit grade on behalf of the instructor.');?></div>
...
<table cellspacing="0" cellpadding="0" class="fs14">
   ...
   <tr>
		...
		<td>YearLevel:</td>
		<td><?php echo $this->Form->input('year_level_id', array('id' => 'YearLevel', 'class' => 'fs14', 'label' => false, 'type' => 'select', 'options' => $yearLevels)); ?></td>
	</tr>

	
	<tr>
		<td colspan="4">
		<?php echo $this->Form->submit(__('Generat Auto Grade For Testing'), array('name' => 'listPublishedCourses', 'div' => false,'class'=>'tiny radius button bg-blue')); ?>
		</td>
	</tr>
</table>
</div>
