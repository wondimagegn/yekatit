...
<tr>
 ...
 echo '<td>'. $this->Form->input('PublishedCourse.program_id',array('label'=>'Program','empty'=>"--Select Program--")).'</td>'; 
            echo '<td>'.$this->Form->input('PublishedCourse.program_type_id',array('label'=>'Program Type',
			'empty'=>"--Select Program Type--")).'</td>';

?>
</tr>
<tr> 
	<?php 
            echo '<td>'.$this->Form->input('PublishedCourse.department_id',array('label'=>'Publish From  Department.','empty'=>"--Select Department--",'id'=>'publish_department_id')).'</td>'; 
		   echo '<td>'.$this->Form->input('PublishedCourse.curriculum_id',array('id'=>'publish_curriculum_id','label'=>'Curriculum.','empty'=>'--select curriculum--')).'</td>'; 
            ?>
    </tr> 
	<?php 
          
            ?>
	<tr><td colspan=2><?php echo $this->Form->submit('Continue',array('name'=>'getsection','div'=>'false','id'=>'disabled_publish',
