...
<tr><td colspan=2 class="smallheading"> Unpublish or delete courses from the publish list.</td></tr>
        <?php 
            echo '<tr><td colspan=2>'.$this->Form->input('PublishedCourse.academic_year',array(
	...
	<?php 
            ...
            echo '<tr><td>'. $this->Form->input('PublishedCourse.program_id',array('empty'=>"--Select Program--")).'</td>'; 
            echo '<td>'. $this->Form->input('PublishedCourse.program_type_id',array('empty'=>"--Select Program Type--")).'</td></tr>'; 
            echo '<tr><td>'.$this->Form->input('PublishedCourse.year_level_id',array('label'=>'Year Level',
			'empty'=>"--Select Year Level--")).'</td><td>'.$this->Form->input('PublishedCourse.semester',array('options'=>array('I'=>'I','II'=>'II',
