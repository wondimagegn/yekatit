...
?>
		...
		echo '<p style="font-size:12px">There are '.
$this->Html->link(__(count($profile_not_build), true), array('controller' => 'students', 'action' => 'profile_not_build_list')).' students profile not build .</p>';
		}
