<div class="box">
	<div class="box-header bg-transparent">
		<div class="box-title" style="margin-top: 10px;"><i class="fontello-plus" style="font-size: larger; font-weight: bold;"></i>
			<span style="font-size: medium; font-weight: bold; margin-top: 20px;"> <?= __('Add Woreda'); ?></span>
		</div>
	</div>
	<div class="box-body">
		<div class="row">
			...
			<div class="large-12 columns">
				<hr>
				<?= $this->Form->end(array('label' => 'Add Woreda', 'id' => 'SubmitID', 'name' => 'saveIt',  'class' => 'tiny radius button bg-blue')); ?>
			</div>
		</div>
	</div>
</div>
...
<script>
	...
	var checkForm = function(form) {
		...
		if (form_being_submitted) {
			alert("Adding Woreda, please wait a moment...");
			form.SubmitID.disabled = true;
			return false;
		}

		form.SubmitID.value = 'Adding Woreda...';
