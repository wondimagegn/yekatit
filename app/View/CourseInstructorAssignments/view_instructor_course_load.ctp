...
<table cellspacing="0" cellpadding="0" class="fs14">
		<tr>
			...
			<td style="width:38%"><?php echo $this->Form->input('Search.academic_year', array('id' => 'AcadamicYear', 'label' => false, 'class' => 'fs14', 'style' => 'width:125px', 'type' => 'select', 'options' => $acyear_array_data)); ?></td>
...
<?php echo $this->Form->input('Search.department_id', array('class' => 'fs14',  'style' => 'width:200px', 'label' => false,'id'=>'department_id_1','empty'=>' ','onchange'=>'updateInstructor(1)','options'=>$departments)); ?>
		...
		<tr>
		<td colspan='4'><?php echo $this->Form->submit(__('View Instructor Load'), array('name' => 'viewInstructorLoad','class'=>'tiny radius button bg-blue','div' => false)); ?></td>
		</tr>
</table>
				...
				*/
                 echo number_format($value['PublishedCourse']['Course']['lecture_hours']*(count($value['PublishedCourse']['CourseRegistration'])/50)+(($value['PublishedCourse']['Course']['laboratory_hours']+0)*0.67)*(count($value['PublishedCourse']['CourseRegistration'])/40),2,'.',',');
                  $loads +=($value['PublishedCourse']['Course']['lecture_hours']*(count($value['PublishedCourse']['CourseRegistration'])/50)+(($value['PublishedCourse']['Course']['laboratory_hours']+0)*0.67)*(count($value['PublishedCourse']['CourseRegistration'])/40));
                             ...
                             echo number_format($value['PublishedCourse']['Course']['lecture_hours']*(count($value['PublishedCourse']['CourseRegistration'])/50)+(($value['PublishedCourse']['Course']['laboratory_hours']+$value['PublishedCourse']['Course']['tutorial_hours'])*0.67)*(count($value['PublishedCourse']['CourseRegistration'])/40),
2, '.', ','); 
