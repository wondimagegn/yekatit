...
<?php echo $this->Form->create('Withdrawal');?>
	<fieldset>
		<legend><?php __('Edit Withdrawal'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('Withdrawal.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('Withdrawal.id'))); ?></li>
