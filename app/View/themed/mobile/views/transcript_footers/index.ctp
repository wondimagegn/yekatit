<div class="transcriptFooters index">
	<div class="smallheading"><?php __('List of Transcript Footers');?></div>
	...
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View', true), array('action' => 'view', $transcriptFooter['TranscriptFooter']['id'])); ?>
			<?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $transcriptFooter['TranscriptFooter']['id'])); ?>
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $transcriptFooter['TranscriptFooter']['id']), null, sprintf(__('Are you sure you want to delete '.$transcriptFooter['Program']['name'].' ('.$transcriptFooter['TranscriptFooter']['academic_year'].') transcript footer?', true), $transcriptFooter['TranscriptFooter']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
