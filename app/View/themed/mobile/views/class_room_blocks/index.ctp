...
<div class="smallheading"><?php __('Class Room Blocks');?></div>
...
<div id="dialog-modal" title="The Class Room Assign To"></div>
	...
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View', true), array('action' => 'view', $classRoomBlock['ClassRoomBlock']['id'])); ?>
			<?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $classRoomBlock['ClassRoomBlock']['id'])); ?>
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $classRoomBlock['ClassRoomBlock']['id']), null, sprintf(__('Are you sure you want to delete block %s?', true), $classRoomBlock['ClassRoomBlock']['block_code'])); ?>
		</td>
	</tr>
		...
		foreach ($classRoomBlock['ClassRoom'] as $classRoom){
			...
			echo '<td style="border-right: #CCC solid 1px">'.$this->Js->link('View Assignment',array('action'=>'get_modal',$classRoom['id']),array('class'=>'jsview','update'=>'#dialog-modal')).'&nbsp;&nbsp;&nbsp'.$this->Html->link(__('Delete', true), array('action' => 'deleteClassRoom', $classRoom['id']), null, sprintf(__('Are you sure you want to delete class room %s?', true), $classRoom['room_code'])).'</td></tr>';
