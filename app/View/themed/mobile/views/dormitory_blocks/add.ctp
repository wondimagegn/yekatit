...
<?php echo $this->Form->create('DormitoryBlock');?>
     ...
     <div class="smallheading"><?php __('Add Dormitory Block and Dormitories'); ?></div>
	<table>
	<?php
	...
	<table id="dormitories">
	  ...
	  <td width="10%">Available</td>
	   ...
	   <?php 
	     if (!empty($this->data['Dormitory']) && count($this->data['Dormitory'])>0) {
		     $count=1;
		         foreach ($this->data['Dormitory'] as $ar=>$av) {
		                echo "<tr><td>".$count++."</td>";
		                echo "<td>".$this->Form->input('Dormitory.'.$ar.'.dorm_number',
		            array('name'=>"data[Dormitory][".$ar."][dorm_number]",
		            'value'=>isset($this->data['Dormitory'][$ar]['dorm_number'])?
					$this->data['Dormitory'][$ar]['dorm_number']:'','size'=>8,'label'=>false,'div'=>false))."</td>";
					  
					  echo "<td>".$this->Form->input('Dormitory.'.$ar.'.floor',array(
		            'value'=>isset($this->data['Dormitory'][$ar]['floor'])?
					$this->data['Dormitory'][$ar]['floor']:'','options'=>$floor_data,'type'=>'select', 'empty'=>'--Select floor---','label'=>false,'div'=>false))."</td>";
			
					echo "<td>".$this->Form->input('Dormitory.'.$ar.'.capacity',
		            array('name'=>"data[Dormitory][".$ar."][capacity]",
		            'value'=>isset($this->data['Dormitory'][$ar]['capacity'])?
					$this->data['Dormitory'][$ar]['capacity']:'', 'size'=>8, 'label'=>false, 'div'=>false))."</td>";
					
  					echo "<td>".$this->Form->input('Dormitory.'.$ar.'.available',array(
		            'value'=>isset($this->data['Dormitory'][$ar]['available'])?
					$this->data['Dormitory'][$ar]['available']:'','label'=>false,'div'=>false))."</td></tr>";
		 ...
		 <TR>
			     ...
			     <TD> 
		            ...
		            'value'=>isset($this->data['Dormitory'][0]['dorm_number'])?
					$this->data['Dormitory'][0]['dorm_number']:'','size'=>8,'label'=>false,'div'=>false));
		            ...
		            'value'=>isset($this->data['Dormitory'][0]['floor'])?
					$this->data['Dormitory'][0]['floor']:'','options'=>$floor_data,'type'=>'select','empty'=>'--Select floor---','label'=>false,'div'=>false)); ?>
				 ...
				 <TD>
                  ...
                  <?php  echo $this->Form->input('Dormitory.0.capacity',
		            ...
		            'value'=>isset($this->data['Dormitory'][0]['capacity'])?
					$this->data['Dormitory'][0]['capacity']:'','size'=>8,'label'=>false,'div'=>false)); ?>
				...
				<TD> 
		            ...
		            'value'=>isset($this->data['Dormitory'][0]['available'])?
					$this->data['Dormitory'][0]['available']:'','checked'=>true,'label'=>false,'div'=>false)); ?>
