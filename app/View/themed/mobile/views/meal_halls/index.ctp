<div class="mealHalls index">
	<h2><?php __('List of Meal Halls');?></h2>
	...
	<tr<?php echo $class;?>>
		...
		<td class="actions">
		<!-- <?php echo $this->Html->link(__('View', true), array('action' => 'view', $mealHall['MealHall']['id'])); ?> -->
			<?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $mealHall['MealHall']['id'])); ?>
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $mealHall['MealHall']['id']), null, sprintf(__('Are you sure you want to delete %s?', true), $mealHall['MealHall']['name'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
