...
<div class="smallheading"><?php __('Split Section For Course'); ?></div>
...
<table class="fs13 small_padding">
		...
		<tr>
            ...
            'empty'=>"--Select Academic Year--",
                'selected'=>isset($this->data['SectionSplitForPublishedCourse']['academicyear'])?
                $this->data['SectionSplitForPublishedCourse']['academicyear']:
