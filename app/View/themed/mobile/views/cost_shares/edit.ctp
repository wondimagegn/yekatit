...
<?php echo $this->Form->create('CostShare',array('type'=>'file'));?>
   <div class="smallheading"><?php __('Maintain Student Cost Share'); ?></div>
	<?php 
 ...
 'onchange'=>'updateStudent(1)','label'=>false,'style'=>'width:250px')).'</td></tr>'; 
		...
		echo '<tr><td style="width:13%">Academic Year</td><td style="width:37%">'.$this->Form->input('academic_year',array('options'=>$acyear_array_data,'type'=>'select','label'=>false)).'</td></tr>';
