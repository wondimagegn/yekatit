...
<p class="smallheading">View Clearance/Withdrawal Applications.</p>
	<table cellspacing="0" cellpadding="0" class="fs14">
		...
		<tr>
		<td colspan='4'><?php echo $this->Form->submit(__('View Clearance/Withdrawal Application', true), array('name' => 'viewClearance', 'div' => false)); ?></td>
		</tr>
</table>
<?php 
}
...
?>
	<h2><?php __('Clearances/Withdraw');?></h2>
	...
	<tr<?php echo $class;?>>
		...
		?>&nbsp;
			...
			<td class="actions">
			    <?php 
			        echo $this->Html->link(__('Cancel', true), array('action' => 'delete', $clearance['Clearance']['id']), null, sprintf(__('Are you sure you want to cancel # %s?', true), $clearance['Clearance']['id']));
