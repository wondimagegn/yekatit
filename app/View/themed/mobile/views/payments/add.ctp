	     ...
	     <td>
	        <table>
	           <tr>
	               <td class="fs16">
	                 <?php 
	                    __('Those checked are payment Applicable to the selected student for <strong> '.$applicable_payments['ApplicablePayment']['academic_year'].' academic year and semester '.$applicable_payments['ApplicablePayment']['semester'].' </strong> .'); 
