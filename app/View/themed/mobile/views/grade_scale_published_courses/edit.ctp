...
<?php echo $this->Form->create('GradeScalePublishedCourse');?>
	<fieldset>
		<legend><?php __('Edit Grade Scale Published Course'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('GradeScalePublishedCourse.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('GradeScalePublishedCourse.id'))); ?></li>
