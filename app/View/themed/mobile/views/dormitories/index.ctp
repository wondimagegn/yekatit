<div class="dormitories index">
	...
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View', true), array('action' => 'view', $dormitory['Dormitory']['id'])); ?>
			<?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $dormitory['Dormitory']['id'])); ?>
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $dormitory['Dormitory']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $dormitory['Dormitory']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
