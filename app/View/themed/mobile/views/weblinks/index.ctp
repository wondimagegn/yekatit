<div class="weblinks index">
	...
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View', true), array('action' => 'view', $weblink['Weblink']['id'])); ?>
			<?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $weblink['Weblink']['id'])); ?>
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $weblink['Weblink']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $weblink['Weblink']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
