...
<div class="preferences index">
    ...
    ?>
	<h2><?php __(' List of students of placed to '.$department_name.' in '.$current_acyear.' Academic Year');?></h2>
	<?php } elseif(isset($college_name) && isset($current_acyear)){
	 ?>
	 <h2><?php __('Accepted Students of '.$college_name.' in '.$current_acyear.' Academic Year');?></h2>
	 <?
	}
...
?>
	...
	<tr<?php echo $class;?>>
	   <td><?php echo $count++;?></td>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View', true), array('controller'=>'accepted_students','action' => 'view', $recentAcceptedStudent['AcceptedStudent']['id'])); ?>
			<?php echo $this->Html->link(__('Edit', true), array('controller'=>'accepted_students','action' => 'edit', $recentAcceptedStudent['AcceptedStudent']['id'])); ?>
