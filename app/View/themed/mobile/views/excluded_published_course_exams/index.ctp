...
<?php echo $this->Form->create('ExcludedPublishedCourseExam');?>
	<div class="smallheading"><?php __('Excluded Published Courses From Final Exams Schedule');?></div>
...
<table cellpadding="0" cellspacing="0">
	...
	<tr<?php echo $class;?>>
		...
		<?php }?>
		<td class="actions">
			<!--- <?php echo $this->Html->link(__('View', true), array('action' => 'view', $excludedPublishedCourseExam['ExcludedPublishedCourseExam']['id'])); ?>
			 <?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $excludedPublishedCourseExam['ExcludedPublishedCourseExam']['id'])); ?> --->
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $excludedPublishedCourseExam['ExcludedPublishedCourseExam']['id']), null, sprintf(__('Are you sure you want to delete?', true), $excludedPublishedCourseExam['ExcludedPublishedCourseExam']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
