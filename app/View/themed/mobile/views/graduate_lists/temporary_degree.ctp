...
<div class="smallheading"><?php __('Temporary Student Degree Printing');?></div>
<table class="fs13">
	<tr>
		...
		<td style="width:75%"><?php echo $this->Form->submit(__('Get Student Temporary Degree', true), array('name' => 'continueTemporaryDegreePrint', 'div' => false)); ?></td>
	</tr>
</table>
<?php
if(!empty($temporary_degree)) {
	...
	echo $this->Form->submit(__('Display Student Temporary Degree', true), array('name' => 'displayTemporaryDegreePrint', 'div' => false));
}
echo $this->Form->end(); ?>
</div>
