...
<div class="smallheading"><?php __('Generate Course Schedule'); ?></div>
...
<div id="dialog-modal" title="Course Details"></div>
	<?php
		...
		echo '<td>'.$this->Form->input('acadamic_year',array('label' => false,'type'=>'select','options'=>$acyear_array_data,'selected'=>isset($selected_academic_year)?$selected_academic_year:"", 'style'=>'width:150px','empty'=>"--Select Academic Year--")).'</td>';
        ...
        echo '<td>'. $this->Form->input('year_level_id',array('label'=>false, 'id'=>'ajax_year_level_id','selected'=>isset($selected_year_level)?$selected_year_level:"",'options'=>$yearLevels,'style'=>'width:150px','empty'=>'--Select Year Level--')).'</td>';  
        ...
        echo '<tr><td colspan="6">'. $this->Form->Submit('Generate',array('name'=>'generate','div'=>false)).'</td></tr>'; 
