...
<div class="smallheading"><?php __('Add Meal Hall Assignment'); ?></div>
...
<?php 	
       ...
       echo '<tr><td>'. $this->Form->Submit('Assign',array('name'=>'assign','div'=>false,'onClick'=>'return confirmMealHallAssignment()')).'</td></tr>';
?>
</table>
</td></tr></table>
