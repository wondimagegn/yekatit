...
<?php echo $this->Form->create('Student',array('type'=>'file'));?>
	...
	<?php		
        ...
        echo "<div class=\"AddTab\">\n";
              ...
              echo "<br/>";
              echo $form->input('Address.zone/subcity');
              echo "<br/>";
              echo $form->input('Address.woreda');
              echo "<br/>";
              echo $form->input('Address.kebele');
              echo "<br/>";
              echo $form->input('Address.house_number');
              echo "<br/>";
              echo $form->input('Address.pobox',array('label'=>'P.O.Box'));
		echo '</div>'; // End add tab div
		?>
