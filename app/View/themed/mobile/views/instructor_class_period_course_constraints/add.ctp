...
<div class="smallheading"><?php __('Add Instructor Class Period Constraints'); ?></div>
	...
	if (isset($instructors)) { 
		...
		if(isset($instructorClassPeriodCourseConstraints)) {
			...
			foreach($instructorClassPeriodCourseConstraints as $instructorClassPeriodCourseConstraint){
				...
				//$this->Html->link(__('View', true), array('action' => 'view', $instructorClassPeriodCourseConstraint['InstructorClassPeriodCourseConstraint']['id'])).'&nbsp;&nbsp;&nbsp;'. 
				$this->Html->link(__('Delete', true), array('action' => 'delete', $instructorClassPeriodCourseConstraint['InstructorClassPeriodCourseConstraint']['id'],"fromadd"),
					null, sprintf(__('Are you sure you want to delete?', true), $instructorClassPeriodCourseConstraint['InstructorClassPeriodCourseConstraint']['id'],"fromadd")).
				"</td></tr>";
			}
			echo "</table>";
		}
