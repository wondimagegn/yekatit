...
echo '<tr><td>'.$this->Form->input('PublishedCourse.academic_year',array(
            ...
            'empty'=>"--Select Academic Year--",'selected'=>isset($this->data['PublishedCourse']['academic_year']) ? $this->data['PublishedCourse']['academic_year'] : $defaultacademicyear)).'</td>';
	...
	<?php 
           ...
           echo '<tr><td>'.$this->Form->input('PublishedCourse.semester',array('options'=>array('I'=>'I','II'=>'II',
            'III'=>'III'),'empty'=>'--select semester--')).'</td>';
                ...
                echo '<td>'.$this->Form->input('PublishedCourse.department_id',
                array('empty'=>'--select department--')).'</td></tr>';   
           
            ?>
	<tr><td colspan=2><?php echo $this->Form->submit('Continue',array('name'=>'getPublishedCourseList','div'=>'false')); ?> </td>	
</tr></table>
...
?>
<div>
<h2><?php __('Select scale you want attach for the given course.');?></h2>
	<table cellpadding="0" cellspacing="0">
	<?php 
	        $count=0;
	        $hide_button=0;
            foreach ($section_organized_published_courses as $section_name=>$sectioned_published_courses) {
                
     ?>
      <tr><td colspan=7><h3><?php echo 'Section:'.$section_name;?></h3></td></tr>
	  <tr>
	        <th></th>
            ...
            <tr>
                <td style='padding:0'> <?php 
                 // echo $this->Form->submit('Unpublished Selected',array('name'=>'unpublishselected','div'=>'false'));?></td>
                  ...
                  echo $this->Form->Submit('Attach/Deattach Scale.',array('name'=>'attachescaletocourse','div'=>'false'));
                  } 
                  ?></td>
