...
?>
<div class="smallheading"><?php __('Edit Graduation Status'); ?></div>
<table class="fs12">
	<tr>
	...
	<tr>
		<td>Academic Year</td>
		<td><?php echo $this->Form->year('academic_year', Configure::read('Calendar.universityEstablishement'), date('Y')+1, (isset($this->data['GraduationStatus']['academic_year']) ? $this->data['GraduationStatus']['academic_year'] : date('Y')), array('empty' => false, 'label' => false, 'div' => false, 'style' => 'width:100px', 'class' => 'fs14')); ?></td>
	</tr>
	<tr>
...
<?php echo $this->Form->end(__('Update Graduation Status', true));?>
</div>
