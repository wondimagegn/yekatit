...
<div class="smallheading"><?php  __('Graduation Status');?></div>
<table class="fs12">
	<tr>
		<td style="width:15%"><?php __('Program'); ?></td>
	...
	<tr>
		<td><?php __('Academic Year'); ?></td>
		<td><?php echo $graduationStatus['GraduationStatus']['academic_year']; ?></td>
	</tr>
	<tr>
		<td><?php __('Applicable For Current Student'); ?></td>
