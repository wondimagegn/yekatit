...
<div class="smallheading"><?php __('Add Course'); ?></div>
	...
	<table>
		...
		echo "<tr><td>".$this->Form->Submit('Select',array('name'=>'selectcurriculum','div'=>false))."</td></tr>";
		?>
	</table>
	<?php } ?>
	...
	<?php 
		echo '<tr><td class="fs15"><strong>College:</strong> '.$college_name.'</td></tr>';
		echo '<tr><td class="fs15"><strong>Department:</strong> '.$department_name.'</td></tr>';
		echo '<tr><td class="fs15"><strong>Curriculum:</strong> '.$curriculums[$this->data['Course']['curriculum_id']].'</td></tr>';
	?>
	</table></td><td><table>
	<?php
	...
	<table>
		...
		echo $this->Form->hidden('Course.curriculum_id',array('value'=>isset($this->data['Course']['curriculum_id']) 
		&& !empty($this->data['Course']['curriculum_id'])? $this->data['Course']['curriculum_id']:''));
		...
		/*
		    if (!empty($this->data['Book'] )) {
		        ...
		        foreach ($this->data['Book'] as $bk=>$bv) {
		            ...
		            array(
		            'value'=>isset($this->data['Book'][$bk]['year_of_publication'])?$this->data['Book'][$bk]['year_of_publication']:'','type'=>'text','size'=>13,'label'=>'','div'=>false)).'</td></tr>';
				 $count++;
		        }
		    } else {
		 ?>
	...
	<?php 
		  ...
		  $fields=array('journal_title'=>'1','article_title'=>'2','author'=>'3','url_address'=>'4','volume'=>'5','issue'=>'6',
			'page_number'=>'7','ISBN'=>'8','url_address'=>9);
		    $all_fields = "";
			$sep = "";
		...
		//,//$all_journal_fields_left $all_journal_fields_right
		?>
		</TABLE>
	<table><tr><td colspan=3>
