...
<?php echo $this->Form->create('ExamRoomCourseConstraint');?>
	<fieldset>
		<legend><?php __('Edit Exam Room Course Constraint'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('ExamRoomCourseConstraint.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('ExamRoomCourseConstraint.id'))); ?></li>
		<li><?php echo $this->Html->link(__('List Exam Room Course Constraints', true), array('action' => 'index'));?></li>
