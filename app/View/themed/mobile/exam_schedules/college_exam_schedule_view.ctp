...
$schedule_count = 1;
?>
<div class="smallheading"><?php __('Exam Schedule View'); ?></div>
	<table>
		<tr>
		...
		<tr>
			<td>Program Type:</td>
			<td><?php echo $this->Form->input('program_type_id', array('options' => $programTypes, 'label' => false, 'style' => 'width:200px', 'multiple' => true)); ?></td>
			<td>Department:</td>
			<td><?php echo $this->Form->input('department_id', array('options' => $departments, 'label' => false, 'style' => 'width:200px', 'multiple' => true)); ?></td>
			<td>Year Level:</td>
			<td><?php echo $this->Form->input('year_level', array('options' => $yearLevels, 'label' => false, 'style' => 'width:200px', 'multiple' => true)); ?></td>
		</tr>
		<tr>
			<td colspan="6">
				<table>
					<tr>
						<td style="width:20%"><?php echo $this->Form->input('organize_by_department', array('type' => 'checkbox', 'checked' => ((!isset($this->data['ExamSchedule']['organize_by_department']) || $this->data['ExamSchedule']['organize_by_department'] == 1) ? 'checked' : 'false'))); ?></td>
						<td style="width:80%"><?php echo $this->Form->input('organize_by_year_level', array('type' => 'checkbox', 'checked' => ((!isset($this->data['ExamSchedule']['organize_by_year_level']) || $this->data['ExamSchedule']['organize_by_year_level'] == 1) ? 'checked' : 'false'))); ?></td>
					</tr>
				</table>
			</td>
		</tr>
		<tr>
			<td colspan="6">
			<?php echo $this->Form->submit(__('View Exam Schedule', true), array('name' => 'viewExamSchedule', 'id' => 'ViewExamSchedule', 'div' => false)); ?>
			</td>
		</tr>
	</table>
	<?php
	//Organize by department and year level
	if(isset($examSchedules) && $this->data['ExamSchedule']['organize_by_department'] == 1 && $this->data['ExamSchedule']['organize_by_year_level'] == 1) {
		?>
		<table class="fs13">
		<?php
		foreach($examSchedules as $department_name => $examSchedulesByYearLevel) {
			foreach($examSchedulesByYearLevel as $year_level => $subExamSchedules) {
				...
				?>
				<tr>
					<td onclick="toggleView(this)" id="<?php echo $count; ?>"><?php echo $html->image('plus2.gif', array('id' => 'i'.$count)); ?></td>
										...
										for($i = 0; $i < $number_of_invigilator; $i++) {
											if(isset($examSchedule['Invigilator'][$i])) {
												if(!empty($examSchedule['Invigilator'][$i]['Staff'])) {
													echo '<li>'.$examSchedule['Invigilator'][$i]['Staff']['full_name'].' ('.$this->Html->link(__('Cancel', true), array('action' => 'cancel_invigilator_assignment', $examSchedule['Invigilator'][$i]['id']), null, sprintf(__('Are you sure you want to cancel "%s" assignment as an invigilator?', true), $examSchedule['Invigilator'][$i]['Staff']['full_name'])).')</li>';
												}
												else {
													echo '<li>'.$examSchedule['Invigilator'][$i]['StaffForExam']['Staff']['full_name'].' ('.$this->Html->link(__('Cancel', true), array('action' => 'cancel_invigilator_assignment', $examSchedule['Invigilator'][$i]['id']), null, sprintf(__('Are you sure you want to cancel "%s" assignment as an invigilator?', true), $examSchedule['Invigilator'][$i]['StaffForExam']['Staff']['full_name'])).')</li>';
												}
											}
											else
												echo '<li>TBA</li>';
								...
								<td style="width:70%">
									...
									<table>
										...
										<tr>
											...
											<td style="width:30%"><?php echo $this->Form->submit(__('Change Exam Hall', true), array('name' => 'changeClassRoom_'.$schedule_count, 'id' => 'ChangeClassRoom_'.$schedule_count, 'div' => false)); ?></td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td style="width:40%"><?php echo $this->Form->submit(__('Change Exam Date', true), array('name' => 'changeExamDate_'.$schedule_count, 'id' => 'ChangeExamDate_'.$schedule_count, 'div' => false)); ?></td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td style="width:40%"><?php echo $this->Form->submit(__('Change Exam Session', true), array('name' => 'changeExamSession_'.$schedule_count, 'id' => 'ChangeExamSession_'.$schedule_count, 'div' => false)); ?></td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td style="width:40%"><?php echo $this->Form->submit(__('Add Invigilator', true), array('name' => 'addInvigilator_'.$schedule_count, 'id' => 'AddInvigilator_'.$schedule_count, 'div' => false)); ?></td>
										</tr>
										<tr>
										...
										<tr>
											...
											echo $this->Form->submit(__('Cancel Exam Schedule', true), array('onclick' => 'return confirm(\''.$cancellation_name.'\')', 'name' => 'cancelExamSchedule_'.$schedule_count, 'id' => 'CancelExamSchedule_'.$schedule_count, 'div' => false)); ?></td>
										</tr>
									</table>
								</td>
							</tr>
	...
	else if(isset($examSchedules) && $this->data['ExamSchedule']['organize_by_department'] == 1) {
		?>
		<table class="fs13">
		<?php
		foreach($examSchedules as $department_name => $examSchedulesByYearLevel) {
	...
	else if(isset($examSchedules) && $this->data['ExamSchedule']['organize_by_year_level'] == 1) {
		?>
		<table class="fs13">
		<?php
