<div class="medicalHistories index">
	<h2><?php __('Medical Histories');?></h2>
	...
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View', true), array('action' => 'view', $medicalHistory['MedicalHistory']['id'])); ?>
			<?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $medicalHistory['MedicalHistory']['id'])); ?>
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $medicalHistory['MedicalHistory']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $medicalHistory['MedicalHistory']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
