...
<?php echo $this->Form->create('ExamGradeChange');?>
	<fieldset>
		<legend><?php __('Edit Exam Grade Change'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('ExamGradeChange.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('ExamGradeChange.id'))); ?></li>
