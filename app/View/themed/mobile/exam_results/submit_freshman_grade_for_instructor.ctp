...
<div class="smallheading"><?php __('View exam result and grade. You can also submit grade on behalf of the instructor.');?></div>
...
else if(count($publishedCourses) <= 1 && empty($this->data)) {
