...
<div class="acceptedStudents index">
 ...
 ?>
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $this->Form->hidden('AcceptedStudent.'.$acceptedStudent['AcceptedStudent']['id'].'.academicyear',array('value'=>$acceptedStudent['AcceptedStudent']['academicyear'])); ?>&nbsp;</td>
