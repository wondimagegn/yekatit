...
<div class="smallheading"><?php __('View makeup exam assignment and suplementary exam result.');?></div>
<table cellspacing="0" cellpadding="0" class="fs14">
	...
	<tr>
		<td colspan="4"><?php echo $this->Form->submit(__('View Makeup Exams', true));  ?></td>
	</tr>
</table>
				...
				<?php
					if(isset($makeup_exam['ExamGradeChange'])) {
						if($makeup_exam['ExamGradeChange']['initiated_by_department'] == 1 && $makeup_exam['ExamGradeChange']['registrar_approval'] == null)
							echo $this->Html->link(__('Delete', true), array('controller' => 'exam_grade_changes', 'action' => 'delete', $makeup_exam['ExamGradeChange']['id']), null, sprintf(__('Are you sure you want to delete %s \'s makeup exam result?', true), $makeup_exam['student_name']));
						else
							echo '---';
					}	
					//needs modification after modifying instructor makeup exam submision
						...
						echo $this->Html->link(__('Delete', true), array('action' => 'delete', $makeup_exam['id']), null, sprintf(__('Are you sure you want to delete %s \'s makeup exam?', true), $makeup_exam['student_name']));
					else
						echo '---';
				?>
				</td>
