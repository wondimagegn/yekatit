...
<p class="smallheading">View Readmission Applications.</p>
	<table cellspacing="0" cellpadding="0" class="fs14">
		...
		?>
		<tr>
		<td colspan='4'><?php echo $this->Form->submit(__('View Readmission Application', true), array('name' => 'viewReadmission', 'div' => false)); ?></td>
		</tr>
</table>
<?php 
}
...
?>
	<div class="smallheading"><?php __('Readmission Application ');?></div>
