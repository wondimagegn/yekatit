...
<?php 
        if (isset($studentIDs)) {
?>
	<div class="smallheading"><?php __('Add Program Type Transfer'); ?></div>
	<table>
	    <tr>
	     <td>
	        <table>
	           ...
	           <td class="fs16">
	             <?php 
	                __('Provide transfered program  which is applicable for the selected student.'); 
	 ...
	 <tr><td> <?php echo $this->Form->Submit('Save',array('name'=>'saveTransfer','div'=>false)); 
	 ?>
	 </td></tr>
	</table>
