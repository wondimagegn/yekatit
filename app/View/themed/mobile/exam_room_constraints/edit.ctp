...
<?php echo $this->Form->create('ExamRoomConstraint');?>
	<fieldset>
		<legend><?php __('Edit Exam Room Constraint'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('ExamRoomConstraint.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('ExamRoomConstraint.id'))); ?></li>
