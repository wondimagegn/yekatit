<div class="examRoomConstraints index">
	<h2><?php __('Exam Room Constraints');?></h2>
	...
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View', true), array('action' => 'view', $examRoomConstraint['ExamRoomConstraint']['id'])); ?>
			<?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $examRoomConstraint['ExamRoomConstraint']['id'])); ?>
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $examRoomConstraint['ExamRoomConstraint']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $examRoomConstraint['ExamRoomConstraint']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
