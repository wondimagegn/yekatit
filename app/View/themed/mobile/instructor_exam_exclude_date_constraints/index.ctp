<div class="instructorExamExcludeDateConstraints index">
	<h2><?php __('Instructor Exam Exclude Date Constraints');?></h2>
	...
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View', true), array('action' => 'view', $instructorExamExcludeDateConstraint['InstructorExamExcludeDateConstraint']['id'])); ?>
			<?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $instructorExamExcludeDateConstraint['InstructorExamExcludeDateConstraint']['id'])); ?>
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $instructorExamExcludeDateConstraint['InstructorExamExcludeDateConstraint']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $instructorExamExcludeDateConstraint['InstructorExamExcludeDateConstraint']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
