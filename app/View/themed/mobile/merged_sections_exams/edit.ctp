...
<?php echo $this->Form->create('MergedSectionsExam');?>
	<fieldset>
 		<legend><?php __('Edit Merged Sections Exam'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('MergedSectionsExam.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('MergedSectionsExam.id'))); ?></li>
