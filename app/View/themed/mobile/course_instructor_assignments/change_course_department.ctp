...
if (isset($turn_off_search)){
 ...
 foreach ($organizedPublishedCourse as $pk => $pv) {
		                ...
		                <tr<?php echo $class;?>>
		                    ...
		                    <td>
			                 ...
			                 $publishedCourse['CourseInstructorAssignment'])) {
	                           ...
	                           'selected'=>isset($this->data['PublishedCourse'][$publishedCourse['PublishedCourse']['id']]['given_by_college_id'])?$this->data['PublishedCourse'][$publishedCourse['PublishedCourse']['id']]['given_by_college_id']:((isset($publishedCourse['GivenByDepartment']['college_id']) ? $publishedCourse['GivenByDepartment']['college_id']: $defaultCollege )),
	                           ...
	                           'style'=>'width:200px',
	                           'selected'=>isset($this->data['PublishedCourse'][
	                           $publishedCourse['PublishedCourse']['id']]['given_by_department_id'])
	                           ?$this->data['PublishedCourse'][
    ...
    echo $this->Form->submit('Change/Dispatch',array('name'=>'changeDispatch','div'=>'false'));
}   
?>
</div>
