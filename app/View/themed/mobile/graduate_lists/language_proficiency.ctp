...
<div class="smallheading"><?php __('Language Proficiency Printing');?></div>
<table class="fs13">
	<tr>
		...
		<td style="width:75%"><?php echo $this->Form->submit(__('Get Student Language Proficiency Letter', true), array('name' => 'continueLanguageProficiencyLetterPrint', 'div' => false)); ?></td>
	</tr>
</table>
<?php
if(!empty($graduation_letter)) {
	...
	if(!empty($graduation_letter_template)) {
		...
		echo $this->Form->submit(__('Display Student Language Proficiency Letter', true), array('name' => 'displayLanguageProficiencyLetterPrint', 'div' => false));
	}
}
echo $this->Form->end(); ?>
</div>
