<div class="graduateLists to_whom_it_may_concern">
<?php echo $this->Form->create('GraduateList');?>
<div class="smallheading"><?php __('To Whom It May Concern Letter Printing');?></div>
<table class="fs13">
	<tr>
		...
		<td style="width:75%"><?php echo $this->Form->submit(__('Get To Whom It May Concern Letter', true), array('name' => 'continueLanguageProficiencyLetterPrint', 'div' => false)); ?></td>
	</tr>
</table>
<?php
if(!empty($graduation_letter)) {
	...
	if(!empty($graduation_letter_template)) {
		...
		echo $this->Form->submit(__('Display To Whom It May Concern Letter', true), array('name' => 'displayLanguageProficiencyLetterPrint', 'div' => false));
	}
}
echo $this->Form->end(); ?>
</div>
