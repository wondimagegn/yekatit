...
// create new PDF document
    ...
    */
    ...
    $fontPath = $pdf->addTTFfont($_SERVER['DOCUMENT_ROOT'].'/app/vendors/tcpdf/fonts/old_english_text_mt.ttf');
    ...
    $fontPath = $pdf->addTTFfont($_SERVER['DOCUMENT_ROOT'].'/app/vendors/tcpdf/fonts/ocraextended.ttf');
    ...
    $fontPath = $pdf->addTTFfont($_SERVER['DOCUMENT_ROOT'].'/app/vendors/tcpdf/fonts/ocraextended.ttf');
    $pdf->SetFont($fontPath, '', 13, '', false);
  	 $pdf->Write(0, 'Graduated from the', '', 0, 'C', true);
    $fontPath = $pdf->addTTFfont($_SERVER['DOCUMENT_ROOT'].'/app/vendors/tcpdf/fonts/palatino_bold.ttf');
    $pdf->Ln(3);
    $pdf->SetFont($fontPath, '', 15, '', false);
