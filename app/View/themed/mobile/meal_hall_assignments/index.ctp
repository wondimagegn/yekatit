...
<div class="smallheading"><?php __('List of Meal Hall Assigned Students'); ?></div>
...
<table cellpadding="0" cellspacing="0">
	...
	<tr<?php echo $class;?>>
		...
		<!-- <td class="actions">
			...
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $mealHallAssignment['MealHallAssignment']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $mealHallAssignment['MealHallAssignment']['id'])); ?>
		</td> -->
	</tr>
<?php endforeach; ?>
	</table>
