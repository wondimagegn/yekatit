...
<h2><?php __('Grade Scales');?></h2>
	...
	?>
	<tr<?php echo $class;?>>
	    <td><?php echo $form->checkbox('GradeScale.selected.'.$gradeScale['GradeScale']['id']);?> </td>
            ...
            <tr>
                <td style='padding:0'> <?php 
                 // echo $this->Form->submit('Unpublished Selected',array('name'=>'unpublishselected','div'=>'false'));?></td>
                   ...
                   <td style='padding:0'> <?php 
                  echo $this->Form->submit('Activate Selected Scale',array('name'=>'activatescale','div'=>'false'));?></td>
