<div class="instructorClassPeriodCourseConstraints index">
	<h2><?php __('List of Instructor Class Period Constraints');?></h2>
	...
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			<!-- <?php echo $this->Html->link(__('View', true), array('action' => 'view', $instructorClassPeriodCourseConstraint['InstructorClassPeriodCourseConstraint']['id'])); ?>
			<?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $instructorClassPeriodCourseConstraint['InstructorClassPeriodCourseConstraint']['id'])); ?> -->
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $instructorClassPeriodCourseConstraint['InstructorClassPeriodCourseConstraint']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $instructorClassPeriodCourseConstraint['InstructorClassPeriodCourseConstraint']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
