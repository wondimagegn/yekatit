...
<div class="sectionSplitForPublishedCourses index">
	<h2><?php __('Split Sections For Published Courses');?></h2>
	...
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View', true), array('action' => 'view', $sectionSplitForPublishedCourse['SectionSplitForPublishedCourse']['id'])); ?>
		<!-- <?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $sectionSplitForPublishedCourse['SectionSplitForPublishedCourse']['id'])); ?> 
