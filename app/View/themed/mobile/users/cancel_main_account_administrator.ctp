...
<div class="smallheading">Main Account Administrator Cancellation</div>
...
<table class="fs12">
    ...
    <tr><td colspan="2"><?php echo $this->Form->Submit('Cancel Main Account Administrator', array('id' => 'SubmitID'));?></td></tr>
</table>
<?php echo $form->end(); ?>
</div>
