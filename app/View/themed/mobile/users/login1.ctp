...
<table border="0" style="margin:0px; padding:0px; width:100%; background:transparent">
	...
	<tr>
		...
		<td style="background:transparent; border-width:0px"><?php e($this->Form->input('username', array('style' => 'height:18px; width:220px', 'class' => 'fullwidth','label'=>false))); ?></td>
	</tr>
	<tr>
		...
		<td style="background:transparent; border-width:0px"><?php e($this->Form->input('password', array('style' => 'height:18px; width:220px', 'class' => 'fullwidth','label'=>false))); ?></td>
	</tr>
	<?php
	...
	?>
	<tr>
		<td colspan="2" style="padding-left:50px; text-align:left; padding-top:20px; color:#0c0691; background:transparent; border-width:0px; font-weight:bold; font-size:15px">Please enter the sum of: <?php e($mathCaptcha); ?></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td colspan="2" style="background:transparent; border-width:0px"><?php e($this->Form->Submit('Sign In', array('div' => false,'class' => 'submitbutton', 'style' => 'width:70px; height:31px; background-color:#689fd8; border-color:#f7fafd; color:#FFFFFF; font-weight:bold'))); ?></td>
	</tr>
	<tr>
		<td colspan="3" style="padding-top:10px; padding-bottom:10px; text-align:left; background:transparent; border-width:0px"><?php echo $this->Html->link(__('Forget Your Password', true).' ?', array('action' => 'forget')); ?></td>
	</tr>
</table>
</td>
</tr>
