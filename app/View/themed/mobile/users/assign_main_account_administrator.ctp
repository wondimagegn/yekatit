...
<div class="smallheading">Main Account Administrator Assignment</div>
...
<table class="fs12">
    ...
    <tr><td colspan="2"><?php echo $this->Form->Submit('Assign Main Account Administrator', array('id' => 'SubmitID'));?></td></tr>
</table>
<?php echo $form->end(); ?>
</div>
