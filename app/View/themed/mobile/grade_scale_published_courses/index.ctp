<div class="gradeScalePublishedCourses index">
	<h2><?php __('Grade Scale Published Courses');?></h2>
	...
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View', true), array('action' => 'view', $gradeScalePublishedCourse['GradeScalePublishedCourse']['id'])); ?>
			<?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $gradeScalePublishedCourse['GradeScalePublishedCourse']['id'])); ?>
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $gradeScalePublishedCourse['GradeScalePublishedCourse']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $gradeScalePublishedCourse['GradeScalePublishedCourse']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
