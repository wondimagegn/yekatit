...
<div class="campuses index">
	<div class="smallheading"><?php __('Campuses');?></div>
	...
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			...
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $campus['Campus']['id']), null, sprintf(__('Are you sure you want to delete "%s" campus??', true), $campus['Campus']['name'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
