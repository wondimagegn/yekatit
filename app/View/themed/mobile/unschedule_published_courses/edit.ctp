...
<?php echo $this->Form->create('UnschedulePublishedCourse');?>
	<fieldset>
		<legend><?php __('Edit Unschedule Published Course'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('UnschedulePublishedCourse.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('UnschedulePublishedCourse.id'))); ?></li>
