...
<table class="fs13 small_padding">
		...
		<tr>
            ...
            'empty'=>"--Select Academic Year--",'selected'=>isset($this->data['Search']['academicyear'])
            ?$this->data['Search']['academicyear']:$defaultacademicyear));
			?>
			</td>
		...
		<tr>
			...
			array('name' => 'getCourseNeedsApproval',  'div' => false)); ?></td>
		</tr>
	</table>
</div>
...
<?php 
		...
		<td class="actions">
			...
			<?php echo $this->Html->link(__('Approve Grade Submission', true), array('action' => 'confirm_grade_submission', $publishedCourse['PublishedCourse']['id'])); ?>
		</td>  
...
<p>
  ...
  onclick="showHideGradeScale('<?php echo $publishedCourseDetail['PublishedCourse']['id'];?>')" id="ShowHideGradeScale">
