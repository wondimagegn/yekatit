...
echo "</table>";
  ...
  <div class="smallheading"><?php __('Course Substitution Request Waiting Decision'); ?></div>
  <?php 
  ...
  <table cellspacing="0" cellpadding="0" class="fs14 small_padding">
		<tr>
		    ...
		    <td style="width:37%"><?php echo $this->Format->humanize_date($this->data['CourseSubstitutionRequest']['request_date']); ?></td>
	    ...
	    <tr>
		  ...
		  <td style="width:37%"><?php 
		   echo $courseBeSubstitueds[$this->data['CourseSubstitutionRequest']['course_for_substitued_id']];
		  echo $this->Form->hidden('course_for_substitued_id'); ?></td>
		  
		  <td style="width:13%">Course Be Substituted:</td>
		  <td style="width:37%"><?php 
		  echo $courseBeSubstitueds[$this->data['CourseSubstitutionRequest']['course_be_substitued_id']];
  ...
  <table>
       ...
       <table>	
        <tr><td>	
		<legend class="smallheading"><?php __('Course Substitution Request Waiting Decision'); ?></legend>
