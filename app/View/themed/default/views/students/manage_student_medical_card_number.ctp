...
<?php echo $this->Form->create('Student');?>
	<div class="smallheading"><?php __('Manage Student Medical Card Number');?></div>
...
?>
	...
	<?php 
		...
		echo '<tr><td colspan="10">'.$this->Form->Submit('Submit',array('name'=>'submit','div'=>false, 'onClick' => 'return confirmCardNumberchange()')).'</td></tr>'; 
	?>
	<tr>
		<th><?php echo ('ID');?></th>
		<th><?php echo ('Name');?></th>
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View', true), array('action' => 'view', $students['Student']['id'])); ?>
			<!-- <?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $students['Student']['id'])); ?> -->
		</td> 
	</tr>
<?php
?>
