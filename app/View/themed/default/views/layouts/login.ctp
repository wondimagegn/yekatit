...
<table style="margin-right:20px; width:100%">
	<tr >
		...
		<?php 
		echo $this->Html->image("amulogo.gif", array(
    "alt" => "Logo",
...
?>
		...
		<td style="width:270px; color:#336eb5; font-family:serif; font-size:18px; font-weight:bold; text-align:center; padding-right:20px">
		<?php 
		    echo $this->Html->link(
    'STUDENT MANAGEMENT INFORMATION SYSTEM',
    array('controller' => 'users', 'action' => 'login'),
    array('style'=>'color:#336eb5; font-family:serif; font-size:18px; font-weight:bold; text-align:center; padding-right:20px;underline:none')
);
		?>
