...
<table class="fs13 small_padding" style="margin-bottom:0px">
   ...
   <tr>
	...
	<tr>
			<td colspan="4"><?php echo $this->Form->submit(__('View Discipline', true), array('name' => 'viewDiscipline', 'id' => 'ViewDisciplineButton', 'div' => false)); ?></td>
	</tr>
	</table>
</div>
...
?>
	...
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View', true), array('action' => 'view', $discipline['Discipline']['id'])); ?>
			
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $discipline['Discipline']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $discipline['Discipline']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
