...
echo '<tr><td>'.$this->Form->input('Student.academic_year',array(
            ...
            'empty'=>"--Select Academic Year--",'selected'=>isset($this->data['Student']['academic_year'])
            ?$this->data['Student']['academic_year']:$defaultacademicyear)).
...
<tr> 
	<?php 
            ...
            ?>
	<tr><td colspan=2><?php echo $this->Form->submit('Continue',array('name'=>'getstudentregistration','div'=>'false')); ?> </td>	
</tr></table>
...
if(isset($organized_published_course_by_section) && !empty($organized_published_course_by_section)) {
    ...
    echo $this->element('student_basic'); 
          ...
          if (!empty($course_registration_id_publish_ids)) {
              ...
              // echo $this->Form->hidden('CourseRegistration.id', array('value' =>$course_registration_id_publish_ids)); 
          }
