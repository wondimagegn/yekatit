...
<p class="smallheading">Please select academic year, department, program and semester for which you want to process readmission application.</p>
	<table cellspacing="0" cellpadding="0" class="fs14">
		...
		<tr>
		<td colspan='4'><?php echo $this->Form->submit(__('Filter Readmission Application', true), array('name' => 'filterReadmission', 'div' => false)); ?></td>
		</tr>
	</table>
<?php } ?>
...
?>
	<div class="smallheading"><?php __('List of readmission applicant filter out by system, based on readmission point and application.');?></div>
	<?php 
	...
	<tr<?php echo $class;?>>
		...
		<td>
			...
			echo $this->Js->link($readmission['Student']['full_name'],array('controller'=>'students','action'=>'get_modal_box',$readmission['Student']['id']),array('class'=>'jsview','update'=>'#dialog-modal'));
...
<?php endforeach; ?>
	...
	<?php
	     ...
	     echo $this->Form->submit('Dispatch To Academic Commission',array('name'=>'saveIt','div'=>'false')); 
