...
<h2><?php  __('Dormitory Block');?></h2>
	<dl><?php $i = 0; $class = ' class="altrow"';?>
		...
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Block Name'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
		...
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Telephone Number'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $dormitoryBlock['DormitoryBlock']['telephone_number']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Alt Telephone Number'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
...
<div class="related">
	...
	<?php
		...
		<tr<?php echo $class;?>>
			...
			<td class="actions">
			<!--<?php echo $this->Html->link(__('View', true), array('controller' => 'dormitories', 'action' => 'view', $dormitory['id'])); ?> -->
				<?php echo $this->Html->link(__('Edit', true), array('controller' => 'dormitories', 'action' => 'edit', $dormitory['id'])); ?>
				<?php echo $this->Html->link(__('Delete', true), array('controller' => 'dormitories', 'action' => 'delete', $dormitory['id']), null, sprintf(__('Are you sure you want to delete dorm %s?', true), $dormitory['dorm_number'])); ?>
			</td>
		</tr>
	<?php endforeach; ?>
	</table>
