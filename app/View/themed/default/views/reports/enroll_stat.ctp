...
<table cellspacing="0" cellpadding="0" class="fs13">
	...
	<tr  class="AttrationRateView" style="display:<?php echo $display; ?>">
						...
						'label' => ' Registered', 'div' => false, 'checked' => (!isset($this->data) || 
						$this->data['Type']['registered'] == 1 ? 'checked' : false)));
						echo '<br/>';
						
						echo $this->Form->input('Type.dismissed', array('type' => 'checkbox', 
						'label' => ' Dismissed', 'div' => false, 
						'checked' => (!isset($this->data) || $this->data['Type']['dismissed'] == 1 ? 
						'checked' : false)));
						...
						'checked' => (!isset($this->data) || $this->data['Type']['dropout'] == 1 ? 
						'checked' : false)));
						...
						'checked' => (!isset($this->data) || $this->data['Type']['withdrawal'] == 1 ? 
						'checked' : false)));
						...
						'checked' => (!isset($this->data) || $this->data['Type']['transferred'] == 1 ? 
						'checked' : false)));
	...
	<tr class="AttrationRateView" style="display:<?php echo $display; ?>">
		<td colspan="6">
		<?php echo $this->Form->submit(__('Get Report', true), array('name' => 'getReport', 'div' => false)); ?>
		</td>
	</tr>
</table>
...
?>
<p class="fs16">
       Students enrollment statistics of <?php echo $this->data['Report']['acadamic_year']; ?> AY, Semester
