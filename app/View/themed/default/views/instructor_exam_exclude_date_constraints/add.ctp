...
<div class="smallheading"><?php __('Add/Edit Instructor Exam Session Exclude Constraint'); ?></div>
...
?>
	...
	foreach($date_array as $dak=>$dav){
			...
			if(isset($already_recorded_instructor_exam_excluded_date_constraints[$dav][1])){
				...
				echo "<td style='border-right: #CCC solid 1px'> Excluded (".$this->Html->link(__('Delete', true), array('action' => 'delete', $already_recorded_instructor_exam_excluded_date_constraints[$dav][1]['id'],"fromadd"),null, sprintf(__('Are you sure you want to delete?', true), $already_recorded_instructor_exam_excluded_date_constraints[$dav][1]['id'],"fromadd")).')'."</td>";
			} else {
			...
			if(isset($already_recorded_instructor_exam_excluded_date_constraints[$dav][2])){
				echo "<td style='border-right: #CCC solid 1px'> Excluded (".$this->Html->link(__('Delete', true), array('action' => 'delete', $already_recorded_instructor_exam_excluded_date_constraints[$dav][2]['id'],"fromadd"),null, sprintf(__('Are you sure you want to delete?', true), $already_recorded_instructor_exam_excluded_date_constraints[$dav][2]['id'],"fromadd")).')'."</td>";
			} else {
			...
			if(isset($already_recorded_instructor_exam_excluded_date_constraints[$dav][3])){
				echo "<td style='border-right: #CCC solid 1px'> Excluded (".$this->Html->link(__('Delete', true), array('action' => 'delete', $already_recorded_instructor_exam_excluded_date_constraints[$dav][3]['id'],"fromadd"),null, sprintf(__('Are you sure you want to delete?', true), $already_recorded_instructor_exam_excluded_date_constraints[$dav][3]['id'],"fromadd")).')'."</td></tr>";
			} else {
