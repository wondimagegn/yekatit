...
?>
	...
	<table>
		...
		<tr>
			<td colspan="6">
			<?php echo $this->Form->submit(__('Generate Exam Schedule', true), array('name' => 'generateExamSchedule', 'id' => 'GenerateExamSchedule', 'div' => false)); ?>
