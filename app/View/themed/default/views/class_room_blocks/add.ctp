...
<?php echo $this->Form->create('ClassRoomBlock');?>
     ...
     <div class="smallheading"><?php __('Add Class Room Block'); ?></div>
	...
	<table id="class_rooms">
	  ...
	  <td width="15%">Lecture Capacity</td><td width="15%">Exam Capacity</td>
	   ...
	   <?php 
	     if (!empty($this->data['ClassRoom']) && count($this->data['ClassRoom'])>0) {
		     $count=1;
		         foreach ($this->data['ClassRoom'] as $ar=>$av) {
		                echo "<tr><td>".$count++."</td>";
		                echo "<td>".$this->Form->input('ClassRoom.'.$ar.'.room_code',
		            array('name'=>"data[ClassRoom][".$ar."][room_code]",
		            'value'=>isset($this->data['ClassRoom'][$ar]['room_code'])?
					$this->data['ClassRoom'][$ar]['room_code']:'','size'=>8,'label'=>false,'div'=>false))."</td>";
					  echo "<td>".$this->Form->input('ClassRoom.'.$ar.'.available_for_lecture',array(
		            'value'=>isset($this->data['ClassRoom'][$ar]['available_for_lecture'])?
					$this->data['ClassRoom'][$ar]['available_for_lecture']:'','label'=>false,'div'=>false))."</td>";
			
  echo "<td>".$this->Form->input('ClassRoom.'.$ar.'.available_for_exam',array(
		            'value'=>isset($this->data['ClassRoom'][$ar]['available_for_exam'])?
					$this->data['ClassRoom'][$ar]['available_for_exam']:'','label'=>false,'div'=>false))."</td>";
					
					echo "<td>".$this->Form->input('ClassRoom.'.$ar.'.lecture_capacity',
		            array('name'=>"data[ClassRoom][".$ar."][lecture_capacity]",
		            'value'=>isset($this->data['ClassRoom'][$ar]['lecture_capacity'])?
					$this->data['ClassRoom'][$ar]['lecture_capacity']:'','size'=>4,'label'=>false,'div'=>false))."</td>";
					
					echo "<td>".$this->Form->input('ClassRoom.'.$ar.'.exam_capacity',
		            array('name'=>"data[ClassRoom][".$ar."][exam_capacity]",
		            'value'=>isset($this->data['ClassRoom'][$ar]['exam_capacity'])?
					$this->data['ClassRoom'][$ar]['exam_capacity']:'','size'=>4,'label'=>false,'div'=>false))."</td></tr>";
		 ...
		 <TR>
			     ...
			     <TD> 
		            ...
		            'value'=>isset($this->data['ClassRoom'][0]['room_code'])?
					$this->data['ClassRoom'][0]['room_code']:'','size'=>8,'label'=>false,'div'=>false));
		            ...
		            'value'=>isset($this->data['ClassRoom'][0]['available_for_lecture'])?
					$this->data['ClassRoom'][0]['available_for_lecture']:'','label'=>false,'div'=>false)); ?>
				 ...
				 <TD>
		            ...
		            'value'=>isset($this->data['ClassRoom'][0]['available_for_exam'])?
					$this->data['ClassRoom'][0]['available_for_exam']:'','label'=>false,'div'=>false)); ?>
				...
				<TD> 
		            ...
		            'value'=>isset($this->data['ClassRoom'][0]['lecture_capacity'])?
					$this->data['ClassRoom'][0]['lecture_capacity']:'','size'=>4,'label'=>false,'div'=>false));
				  ...
				  <TD> 
		            ...
		            'value'=>isset($this->data['ClassRoom'][0]['exam_capacity'])?
					$this->data['ClassRoom'][0]['exam_capacity']:'','size'=>4,'label'=>false,'div'=>false));
				  ...
				  <!-- <TD>
					<?php 
						echo $this->Form->input('ClassRoom.0.ClassRoom.program_type_id',array('type'=>'select',
							'multiple'=>'checkbox','options'=>$programTypes,'div'=>'input select','label'=>false));
					?>
				  </TD>
				<TD>
					<?php 
					
					echo $this->Form->input('ClassRoom.0.ClassRoom.program_id',array('type'=>'select',
						'multiple'=>'checkbox','options'=>$programs,'div'=>'input select','label'=>false));
