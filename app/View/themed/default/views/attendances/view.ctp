...
$(document).ready(function () {
	$("#PublishedCourse").change(function(){
		...
		window.location.replace("/attendances/<?php echo $this->action; ?>/"+pc_id);
	});
...
<div class="attendances <?php echo $this->action; ?>">
<?php echo $this->Form->create('Attendance');?>
<div class="smallheading"><?php __('View Attendance'); ?></div>
