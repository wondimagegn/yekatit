...
<div class="gradeTypes form">
		...
		<div class="smallheading"><?php __('Add Grade Type'); ?></div>
	<table>
	...
	<td>
	  <table id="grade"><tr><th>S.No</th><th>Grade</th><th>Point Value</th><th>Pass Grade</th></tr>
		            ...
		            array( 'value'=>isset($this->data['Grade'][$bk]['pass_grade'])?$this->data['Grade'][$bk]['point_value']:'','label'=>false,'div'=>false));
		                      echo "</td></tr>";
		                      $count++;
		                  }
		         } else {
		            ...
		            array( 'value'=>isset($this->data['Grade'][0]['pass_grade'])?$this->data['Grade'][0]['point_value']:'','label'=>false,'div'=>false));
		                      echo "</td></tr>";
		         }
		         ?>
