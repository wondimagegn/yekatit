...
<div class="users form">
    ...
    <div class="smallheading"><?php __('Assign Meal Hall Responsibility'); ?></div>
    ...
    <?php 
            ...
            echo '<tr><td>'.$this->Form->input('meal_hall_id',array('type' => 'select', 
                  ...
                  foreach ($alreadyAssignedMealHalls as $campus=>$assignment) {
                     echo '<tr><td colspan=4 style="text-align:center">'.$campus.'</td></tr>';
                        ...
                        foreach ($assignment as $as=>$av) {
                           ...
                           echo $this->Html->link(__('Unassign', true), array('action' => 'assign_user_meal_hall', $av['User']['id'],$av['UserMealAssignment']['id']), null, sprintf(__('Are you sure you want to unassigned  %s from '.$av['MealHall']['name'].' meal hall ?', true), $av['User']['full_name'])); 
                           echo '</td></tr>';
                        }
                  }
                  echo '</table>';
