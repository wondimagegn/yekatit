...
<tr><th colspan=3> <?php __('Total Number of privileged students ') ?></th></tr>
...
<p onclick="toggleView('all_stat')" class="fs15" style="font-weight:bold; padding-bottom:0px; margin-bottom:0px"><?php echo $html->image('plus2.gif', array('id' => 'iall_stat')); ; ?> All student preference stat</p>
...
<p onclick="toggleView('female_stat')" class="fs15" style="font-weight:bold; padding-bottom:0px; margin-bottom:0px"><?php echo $html->image('plus2.gif', array('id' => 'ifemale_stat')); ; ?> Female students preference stat</p>
...
<p onclick="toggleView('region_stat')" class="fs15" style="font-weight:bold; padding-bottom:0px; margin-bottom:0px"><?php echo $html->image('plus2.gif', array('id' => 'iregion_stat')); ; ?> Developing regions preference stat</p>
...
<p onclick="toggleView('disable_stat')" class="fs15" style="font-weight:bold; padding-bottom:0px; margin-bottom:0px"><?php echo $html->image('plus2.gif', array('id' => 'idisable_stat')); ; ?> Disable students preference stat</p>
...
<?php 
    ...
    foreach($departments as $key=>$value){
       ...
       && $check_auto_placement_already_run_not_allow_adding_or_edit>0) {
        ...
        array('value'=>(empty($this->data['ParticipatingDepartment'][$count]['number'])?$value['ParticipatingDepartment']['number'] : $this->data['ParticipatingDepartment'][$count]['number']),
        'label'=>'Department Capacity', 'style' => 'width:150px','label'=>false)).'</td><td>';
         echo $this->Form->input('ParticipatingDepartment.'.$count.'.female',
        array('value'=> (empty($this->data['ParticipatingDepartment'][$count]['female'])?$value['ParticipatingDepartment']['female'] : $this->data['ParticipatingDepartment'][$count]['female']),
        'label'=>'Female', 'style' => 'width:150px','label'=>false)).'</td><td>';
        echo $this->Form->input('ParticipatingDepartment.'.$count.'.regions',
        array('value'=> (empty($this->data['ParticipatingDepartment'][$count]['regions'])?$value['ParticipatingDepartment']['regions'] : $this->data['ParticipatingDepartment'][$count]['regions']),
        'label'=>'Regions Quota', 'style' => 'width:150px','label'=>false)).'</td><td>';   
        
         echo $this->Form->input('ParticipatingDepartment.'.$count.'.disability',
        array('value'=> (empty($this->data['ParticipatingDepartment'][$count]['disability']) ? $value['ParticipatingDepartment']['disability']:$this->data['ParticipatingDepartment'][$count]['disability']),
...
'div'=>'input select','disabled'=>true,'value'=>(empty($this->data['ParticipatingDepartment']['developing_regions_id']) ? $selected_region_ids:$this->data['ParticipatingDepartment']['developing_regions_id'])));  

} else {
  echo $this->Form->input('ParticipatingDepartment.developing_regions_id', 
array('type' => 'select', 'multiple' => 'checkbox',
'div'=>'input select','value'=>(empty($this->data['ParticipatingDepartment']['developing_regions_id']) ? $selected_region_ids:$this->data['ParticipatingDepartment']['developing_regions_id'])));
}
