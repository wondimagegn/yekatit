...
<?php 
echo 'Number <input type="text" name="data[ParticipatingDepartment][number]" 
id="ParticipatingDepartmentNumber"><br/>';
foreach($departments as $key=>$value){
echo '<input type="checkbox" name="data[ParticipatingDepartment][department_id][]" value='.$key.' id="ParticipatingDepartmentDepartmentId'.$key.'">';
...
-->
<!-- http://jamnite.blogspot.com/2009/05/cakephp-form-validation-with-ajax-using.html
<?php echo $this->Html->script('jquery-1.6.2.min'); ?>  
<?php echo $this->Html->script('quotavalidation');?>
-->
...
<tr><td class='headerfont' colspan="4"><?php __('Add Departments Quota') ?></td></tr>
<?php 
    //debug($departments);
    foreach($departments as $key=>$value){
