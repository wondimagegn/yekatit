...
<?php
    if(empty($roles)){
            echo "<div class='message'>". __('There is no user in the database. First Populate
            your database  with list of users ',true)."</div>";
    } else {
?>
<?php 
...
?>
	<fieldset>
 		<legend class="smallheading"><?php __('Send Mail');?></legend>
	<?php
