...
<?php echo $this->Form->create('AcceptedStudent');?>
		...
		<div class='smallheading'><?php __('Add Accepted Student'); ?></div>
...
<ol class="fs13" style="padding-top:0px; margin-top:0px">
	...
	echo '<table><tr>';
	   echo '<td>';
		        ...
		        //echo '<tr><td style="padding-left:350px;">'. $this->Form->input('sex',$options,$attributes).'</td></tr>';
		...
		echo '<td>';
            ...
            echo '<tr><td>'.$this->Form->input('academicyear',array('id'=>'academicyear',
                ...
                'selected'=>isset($this->data['AcceptedStudent']['academicyear']) 
                && !empty($this->data['AcceptedStudent']['academicyear']) ? $this->data['AcceptedStudent']['academicyear']:$defaultacademicyear)).'</td></tr>';
