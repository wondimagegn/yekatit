...
<?php echo $this->Form->create('ExamPeriod');?>
	<div class="smallheading"><?php __('List of Exam Periods');?></div>
...
<table cellpadding="0" cellspacing="0">
	...
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			<!--- <?php echo $this->Html->link(__('View', true), array('action' => 'view', $examPeriod['ExamPeriod']['id'])); ?> --->
			<?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $examPeriod['ExamPeriod']['id'])); ?>
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $examPeriod['ExamPeriod']['id']), null, sprintf(__('Are you sure you want to delete?', true), $examPeriod['ExamPeriod']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
