...
<h2><?php  __('Exam Period');?></h2>
	<dl><?php $i = 0; $class = ' class="altrow"';?>
		...
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Default Number Of Invigilator Per Exam'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
...
<div class="related">
	<h3><?php __('Related Exam Excluded Date And Sessions');?></h3>
	<?php if (!empty($examPeriod['ExamExcludedDateAndSession'])):?>
	<table cellpadding = "0" cellspacing = "0">
	<tr>
		<th><?php __('Id'); ?></th>
		<th><?php __('Exam Period Id'); ?></th>
		<th><?php __('Excluded Date'); ?></th>
	...
	<?php
		...
		<tr<?php echo $class;?>>
			...
			<td class="actions">
				<?php echo $this->Html->link(__('View', true), array('controller' => 'exam_excluded_date_and_sessions', 'action' => 'view', $examExcludedDateAndSession['id'])); ?>
				<?php echo $this->Html->link(__('Edit', true), array('controller' => 'exam_excluded_date_and_sessions', 'action' => 'edit', $examExcludedDateAndSession['id'])); ?>
				<?php echo $this->Html->link(__('Delete', true), array('controller' => 'exam_excluded_date_and_sessions', 'action' => 'delete', $examExcludedDateAndSession['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $examExcludedDateAndSession['id'])); ?>
			</td>
		</tr>
	<?php endforeach; ?>
	</table>
