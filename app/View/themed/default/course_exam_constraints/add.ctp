...
<div class="smallheading"><?php __('Add Course Exam Session Constraints'); ?></div>
...
?>
	...
	foreach($exam_period_dates_array as $epdak=>$epdav){
		...
		isset($already_recorded_course_exam_constraints_by_date[$epdav][0]) ){
			...
			echo "<td style='border-right: #CCC solid 1px'>".$active.' ('.$this->Html->link(__('Delete', true), array('action' => 'delete', $already_recorded_course_exam_constraints_by_date[$epdav][1]['id'],"fromadd"),null, sprintf(__('Are you sure you want to delete?', true), $already_recorded_course_exam_constraints_by_date[$epdav][1]['id'],"fromadd")).')'."</td>";
		} else {
		...
		if(isset($excluded_session_by_date[$epdav][2])){
			...
			echo "<td style='border-right: #CCC solid 1px'>".$active.' ('.$this->Html->link(__('Delete', true), array('action' => 'delete', $already_recorded_course_exam_constraints_by_date[$epdav][2]['id'],"fromadd"),null, sprintf(__('Are you sure you want to delete?', true), $already_recorded_course_exam_constraints_by_date[$epdav][2]['id'],"fromadd")).')'."</td>";
		} else {
		...
		if(isset($excluded_session_by_date[$epdav][3])){
			...
			echo "<td style='border-right: #CCC solid 1px'>".$active.' ('.$this->Html->link(__('Delete', true), array('action' => 'delete', $already_recorded_course_exam_constraints_by_date[$epdav][3]['id'],"fromadd"),null, sprintf(__('Are you sure you want to delete?', true), $already_recorded_course_exam_constraints_by_date[$epdav][3]['id'],"fromadd")).')'."</td>";
		} else {
