...
<div class="smallheading"><?php __('Graduation Statuses');?></div>
...
<table cellpadding="0" cellspacing="0">
	<tr>
			...
			<th style="width:13%; text-align:center" class="actions"><?php __('Actions');?></th>
	</tr>
	<?php
	$i = 0;
	...
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View', true), array('action' => 'view', $graduationStatus['GraduationStatus']['id'])); ?>
			<?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $graduationStatus['GraduationStatus']['id'])); ?>
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $graduationStatus['GraduationStatus']['id']), null, sprintf(__('Are you sure you want to delete "%s" status?', true), $graduationStatus['GraduationStatus']['status'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
