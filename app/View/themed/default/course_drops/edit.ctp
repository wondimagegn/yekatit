...
<?php echo $this->Form->create('CourseDrop');?>
	<fieldset>
		<legend><?php __('Edit Course Drop'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('CourseDrop.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('CourseDrop.id'))); ?></li>
