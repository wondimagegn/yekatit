...
<?php echo $this->Form->create('MergedSectionsExam');?>
	<div class="smallheading"><?php __('List of Merged Sections For Exams');?></div>
...
<table cellpadding="0" cellspacing="0">
	...
	<tr<?php echo $class;?>>
		...
		<?php if(isset($mergedSectionsExam['PublishedCourse']['YearLevel']['name'])) {?>
		 ...
		 <?php }?>
		<td class="actions">
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $mergedSectionsExam['MergedSectionsExam']['id']), null, sprintf(__('Are you sure you want to delete?', true), $mergedSectionsExam['MergedSectionsExam']['id'])); ?> 
		</td>
	</tr>
<?php endforeach; ?>
	</table>
