...
<table class="fs13 small_padding" style="margin-bottom:0px">
   ...
   <tr>
	...
	<tr>
			<td colspan="4"><?php echo $this->Form->submit(__('View Program Transfer', true), array('name' => 'viewProgramTransfer', 'id' => 'viewProgramTransfer', 'div' => false)); ?></td>
	</tr>
	</table>
</div>

<div class="programTypeTransfers index">
	<h2><?php __('Program Type Transfers');?></h2>
	...
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			...
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $programTypeTransfer['ProgramTypeTransfer']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $programTypeTransfer['ProgramType']['name'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
