...
?>
	...
	<tr<?php echo $class;?>>
		...
		<td class="actions" >
			...
			<?php //echo $this->Html->link(__('Edit', true), array('action' => 'edit', $acceptedStudent['AcceptedStudent']['id'])); ?>
...
'action'=>'admit'));?>
		...
		<div class="headerfont"><?php __('Admit Student'); ?></div>
		<div id="basic_fields" style="display:block">	
		 <?php
            ...
            'divorced'=>'Divorced','windowed'=>'Windowed'),'empty'=>'--select marital status--')).'</td></tr>';
		        ...
		        echo $this->Form->hidden('curriculum_id',array('value'=>isset($this->data['Student']['curriculum_id'])?
		        $this->data['Student']['curriculum_id']:''));
		       ...
		       // echo '<tr><td>'.$this->Form->input('User.username',array('label'=>'Desired Login Name','value'=>$this->data['Student']['studentnumber'],'disabled'=>true)).'</td></tr>';
		        echo "<tr><td> Username: ".$this->data['Student']['studentnumber']."</td></tr>";
		          ...
		          /*  echo "<tr><td>". $this->Form->input('program_id',
		            array('style'=>'width:150px','disabled'=>true))."</td></tr>";
				echo "<tr><td>". $this->Form->input('program_type_id',
				array('style'=>'width:150px','disabled'=>true))."</td></tr>";
		        echo "<tr><td>". $this->Form->input('college_id',
		        array('style'=>'width:150px','disabled'=>true))."</td></tr>";
              
		        //echo '<tr><td>'.$this->Form->input('Department',array('type' => 'select', 'multiple' => 'checkbox','div'=>'input select ajax_page_id' ).'</td></tr>';
		        if(PROGRAM_TYPE_REGULAR != $this->data['Student']['program_type_id']) {
                 echo "<tr><td>". $this->Form->input('Department',array('empty'=>"--Select Department--",
                  'selected'=>isset($selected_department)?$selected_department:'',
                  'readOnly'=>true))."</td></tr>";
                  } else {
				  echo $this->Form->hidden('department_id',array('value'=>isset($this->data['Student']['department_id']) && 
				  !empty($this->data['Student']['department_id'])?$this->data['Student']['department_id'] :''));
				  }
                  echo '<tr><td>'. $this->Form->input('admissionyear',array('label'=>'Admission Year','readOnly'=>true)).'</td></tr>';
                  */
             ...
             // save account information in the user table
		       ...
		       // echo '<tr><td colspan=6><hr/></td></tr>';
                ...
                <th>National Exam Taken</th><th>Town</th><th>Zone</th><th>Region</th></tr>';
		            ...
		            array(
		            'value'=>isset($this->data['HighSchoolEducationBackground'][0]['school_level'])?$this->data['HighSchoolEducationBackground'][0]['school_level']:'','label'=>false,'div'=>false,'size'=>13)).'</td><td>'.
                 ...
                 echo '<tr><th>No.</th><th>Name of Institution/College</th><th>Field of study</th><th>Diploam Awared</th><th>Date graduated </th><th>CGPA at Graduation</th></tr>';
		            ...
		            array('size'=>4,'label'=>false,'div'=>false)).'</td></tr>';
		             ...
		             /*echo "<tr><td>1</td><td>".$this->Form->input('HigherEducationBackground.0.name',
		                array('name'=>"data[HigherEducationBackground][0][name]",
		                'value'=>isset($this->data['HigherEducationBackground'][0]['name'])?
					    $this->data['HigherEducationBackground'][0]['name']:'','div'=>false,'label'=>false))."</td>";
					
					    echo "<td>".$this->Form->input('HigherEducationBackground.0.field_of_study',
		                array('name'=>"data[HigherEducationBackground][0][field_of_study]",
		                'value'=>isset($this->data['HigherEducationBackground'][0]['field_of_study'])?
					    $this->data['EheeceResult'][0]['field_of_study']:'','div'=>false,'label'=>false))."</td>";
					...
					echo "<td>".$this->Form->input('HigherEducationBackground.0.cgpa_at_graduation',
		                array('div'=>false,'label'=>false))."</td></tr>";
		         */
		         ?>
