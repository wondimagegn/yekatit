...
<div class="smallheading"><?php __('Add Class Room Class Period Constraint'); ?></div>
...
<table cellpadding="0" cellspacing="0">
	<?php 
		...
		<?php
        echo '<tr><td colspan="6">'. $this->Form->Submit('Submit',array('name'=>'submit','div'=>false)).'</td></tr>'; 
        ...
        <?php 
				if(isset($fromadd_already_recorded_class_room_class_period_constraints)) {
					...
					foreach($fromadd_already_recorded_class_room_class_period_constraints as $arck=>$arcv){
						...
						$this->Html->link(__('Delete', true), array('action' => 'delete', $arcv['ClassRoomClassPeriodConstraint']['id'],"fromadd"),null, sprintf(__('Are you sure you want to delete?', true), $arcv['ClassRoomClassPeriodConstraint']['id'],"fromadd")).
						"</td></tr>";
					}
					?></table><?php
				}
