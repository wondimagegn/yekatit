<div class="classRoomClassPeriodConstraints index">
	<h2><?php __('List of Class Room Class Period Constraints');?></h2>
	...
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			<!-- <?php echo $this->Html->link(__('View', true), array('action' => 'view', $classRoomClassPeriodConstraint['ClassRoomClassPeriodConstraint']['id'])); ?>
			<?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $classRoomClassPeriodConstraint['ClassRoomClassPeriodConstraint']['id'])); ?> -->
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $classRoomClassPeriodConstraint['ClassRoomClassPeriodConstraint']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $classRoomClassPeriodConstraint['ClassRoomClassPeriodConstraint']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
