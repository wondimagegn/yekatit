...
<div class="smallheading"><?php __('Add Course Number of Session'); ?></div>

<table cellpadding="0" cellspacing="0">
	<?php 
		/*echo '<div>Note:The default course number of session for all courses is 1. 
			Herewith you can change the default course number of session for any given course,
		</div>';*/
