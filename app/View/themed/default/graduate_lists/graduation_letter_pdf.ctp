...
+251-046-8810097-ext. 374/375
    ...
    $pdf->MultiCell(157, 7, 'አምቦ፡ ኢትዮጵያ', 0, 'C', false, 0, 27, 38);
    ...
    $pdf->MultiCell(157, 7, 'Ambo , Ethiopia', 0, 'C', false, 0, 27, 43);
	 //Reference Number
    ...
    $pdf->MultiCell(100, 7, 'ambo_registrar@ambou.edu.et', 0, 'L', false, 0, 10, 270);
    ...
    $pdf->Output('graduation_letter-'.$graduation_letter['student_detail']['Student']['full_name'].'.pdf', 'I');
    /*
