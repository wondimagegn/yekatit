...
<table class="fs13 small_padding" style="margin-bottom:0px">
   ...
   <tr>
	...
	<tr>
			<td colspan="4"><?php echo $this->Form->submit(__('View Applicable Payment', true), array('name' => 'viewPayment', 'id' => 'ViewPaymentButton', 'div' => false)); ?></td>
	</tr>
	</table>
</div>
...
?>
	<h2><?php __('Applicable Payments');?></h2>
	...
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View', true), array('action' => 'view', $applicablePayment['ApplicablePayment']['id'])); ?>
			<?php //echo $this->Html->link(__('Edit', true), array('action' => 'edit', $applicablePayment['ApplicablePayment']['id'])); ?>
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $applicablePayment['ApplicablePayment']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $applicablePayment['ApplicablePayment']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
