...
<div class="smallheading"><?php __('Top Student View'); ?></div>
...
<table cellspacing="0" cellpadding="0" class="fs13">
	...
	<tr class="AttrationRateView" style="display:<?php echo $display; ?>">
		...
		<td style="width:15%">Top:</td>
		<td style="width:50%" colspan="3"><?php echo $this->Form->input('top', array('id' => 'Top', 
		'class' => 'fs13', 'label' => false,'onkeypress'=>'validate(event)' )); ?></td>
	</tr>
	...
	<tr class="AttrationRateView" style="display:<?php echo $display; ?>">
		...
		<td style="width:35%"><?php echo $this->Form->input('gender', array('id' => 'Gender', 
