...
<div class="smallheading"><?php __('Academically Dismissed Student  View'); ?></div>
...
?>
    <p class="fs16">
           List of academically Dismissed Students during  <?php echo $this->data['Report']['acadamic_year']; ?> A/Y, 
