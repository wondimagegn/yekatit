...
<div class="smallheading"><?php __('View Course Schedules');?></div>
	...
	<?php
        ...
        echo '<tr><td colspan="6">'. $this->Form->Submit('Continue',array('name'=>'continue','div'=>false)).'</td></tr>'; 
...
<?php 
	if (isset($sections)) { 
		...
		echo '<tr><td>'.$this->Form->Submit('View',array('div'=>false,'name'=>'view')).'</td></tr>';
		echo '</table>';
	}
