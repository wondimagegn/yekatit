...
<table class="fs13 small_padding" style="margin-bottom:0px">
	...
	<tr>
			<td colspan="4"><?php echo $this->Form->submit(__('View Course Map ', true), array('name' => 'viewCourseMap', 'id' => 'viewCourseMap', 'div' => false)); ?></td>
	</tr>
	</table>
</div>
<div class="equivalentCourses index">
	<div class="smallheading"><?php __('Equivalent Courses');?></div>
	...
	<tr<?php echo $class;?>>
		...
		<td class="actions">
				...
				<?php echo $this->Html->link(__('Delete Map', true), array('action' => 'delete', 
			$equivalentCourse['EquivalentCourse']['id']), null, sprintf(__('Are you sure you want to delete  %s?', true), $equivalentCourse['CourseBeSubstitued']['course_code'].'-'.$equivalentCourse['CourseBeSubstitued']['course_title'].' mapped '.$equivalentCourse['CourseForSubstitued']['course_code'].'-'.$equivalentCourse['CourseForSubstitued']['course_title'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
