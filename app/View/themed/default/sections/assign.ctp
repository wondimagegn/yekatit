...
<div class="centeralign_smallheading"><?php echo __('Section Assignment Only for Freshman Students')?></div>
...
?>
	<fieldset>
 		<legend class="smallheading"><?php __('Assign students to the given section'); ?></legend>
...
<?php echo $this->Form->Submit('Submit',array('div'=>false,'name'=>'assign'));?> 
<?php 
