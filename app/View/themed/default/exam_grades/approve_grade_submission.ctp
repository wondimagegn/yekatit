...
!empty($grade_submitted_courses_organized_by_published_course)) { 
		...
		<td class="actions">
			...
			<?php echo $this->Html->link(__('Approve Grade Submission', true), 
...
//debug($grade_submitted_courses_rejected_organized_by_published_course);
		...
		<td class="actions">
			...
			echo $this->Html->link(__('Approve Grade Submission', true), array('action' => ($department == 1 ? 'approve_non_freshman_grade_submission' : 'approve_freshman_grade_submission'), 
			$publishedCourse['PublishedCourse']['id'])); ?>
		</td>  
...
<table>
<tr> <td colspan=2> <?php
 echo $this->Form->Submit('Approve Grade Submission',array('div'=>false,
 'name'=>'approvegradesubmission'));
 ?> </td>
</tr>
