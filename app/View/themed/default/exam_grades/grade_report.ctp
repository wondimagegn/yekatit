...
<div class="smallheading"><?php __('Student Examination Grade Report');?></div>
...
<table cellspacing="0" cellpadding="0" class="fs14">
	...
	<tr>
		<td colspan="6">
		<?php echo $this->Form->submit(__('Get Sections', true), array('name' => 'listSections', 'div' => false)); ?>
		</td>
	</tr>
</table>
</div>
...
if(isset($students_in_section) && empty($students_in_section)) {
	...
	<?php echo $this->Form->submit(__('Get Grade Report', true), array('name' => 'getGradeReport', 'div' => false)); ?>
	<?php
