...
<div class="smallheading"><?php __('Edit Graduation Letter Template'); ?></div>
<table>
	<tr>
		<td>Type of Letter:</td>
		<td><?php echo $this->Form->input('id'); 
		echo $this->Form->input('type', array('label' => false, 'type' => 'select', 'options' => array('Language Proficiency' => 'Language Proficiency', 'To Whom It May Concern' => 'To Whom It May Concern'))); ?></td>
	</tr>
	<tr>
		<td>Program:</td>
	...
	<tr>
		...
		//$this->Form->year('academic_year', Configure::read('Calendar.universityEstablishement'), date('Y')+1, date('Y'), array('empty' => false, 'label' => false, 'div' => false, 'style' => 'width:100px', 'class' => 'fs14')); ?></td>
	</tr>
	<tr>
