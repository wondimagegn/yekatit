...
?>
<div class="info-box info-message"> List of students department transfer request approved by the sender department and college and waiting your deparment decision </div>
	   ...
	   <?php 
		  ...
		  echo $this->Form->hidden('DepartmentTransfer.'.$start.'.student_id',
		    ...
		    <td>
		          ...
		          echo $this->Form->input('DepartmentTransfer.'.$start.'.receiver_department_remark',
		          array('label'=>false));
...
if (!empty($departmentTransfersLeaverRequest)) {
  ...
  // $attributes=array('legend'=>false);
   $attributes=array('legend'=>false,'label'=>false,'separator'=>'<br/>');
?>
<div class="info-box info-message"> List of your department students who submitted  department transfer request and waiting your decision for transfer, those accepted transfer request will be forwarded to college for approval.  </div>
<table cellpadding="0" cellspacing="0">
	<tr>
		    <th>S.N<u>o</u></th>
			<th><?php echo 'Full Name';?></th>
	...
	<tr<?php echo $class;?>>
	   ...
	   <?php 
		...
		<td>
		  <?php 
		      echo $this->Form->input('DepartmentTransfer.'.$start.'.minute_number',
		      array('label'=>false,'size'=>'8px'));
		...
		<td><?php 
		  ...
		  <td><?php 
		      ...
		      echo $this->Form->input('DepartmentTransfer.'.$start.'.sender_department_remark',
		      array('label'=>false));
