...
<table cellspacing="0" cellpadding="0" class="fs14">
		...
		<tr>
		<td colspan='4'><?php echo $this->Form->submit(__('View Substitution'), array('name' => 'viewSubstitution', 'div' => false)); ?></td>
		</tr>
	</table>
...
<?php //debug($courseSubstitutionRequests); ?>
	<div class="smallheading"><?php echo __('Course Substitution Requests.');?></div>
	<table cellpadding="0" cellspacing="0">
	<tr>
