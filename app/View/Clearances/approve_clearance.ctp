...
<p class="smallheading">Please select academic year, department, program and semester for which you want to approve clearance/withdraw application.</p>
	<table cellspacing="0" cellpadding="0" class="fs14">
		...
		<tr>
		<td colspan='4'><?php echo $this->Form->submit(__('Filter Clearnce Application'), array('name' => 'filterClearnce', 
'div' => false,'class'=>'tiny radius button bg-blue')); ?></td>
		</tr>
	</table>
...
?>
	<div class="smallheading"><?php echo __('List of clearance/withdraw applicant processed by the system and not taken properties from the concerned bodies and waiting your decision.');?></div>
	<?php 
...
<?php endforeach; ?>
	...
	echo $this->Form->submit('submit',array('name'=>'saveIt','div'=>'false','class'=>'tiny radius button bg-blue')); 
