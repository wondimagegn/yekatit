...
<?php 
echo $this->Form->create('Clearance',array('novalidate' => true));
?>
	...
	<table cellspacing="0" cellpadding="0" class="fs14">
		...
		<!--
		 <tr>
		  	<td> Type:</td>
			<td><?php 
			echo $this->Form->input('Search.clear', array('type' => 'checkbox', 'label' => 'Clearance Approved', 'div' => false, 'checked' => (!isset($this->request->data) || $this->request->data['Search']['clear'] == 1 ? 'checked' : false))).'<br/>';
			echo $this->Form->input('Search.notcleared', array('type' => 'checkbox', 'label' => 'Not Clearance  Approved', 'div' => false, 'checked' => (!isset($this->request->data) || $this->request->data['Search']['notcleared'] == 1 ? 'checked' : false)));
			
			?></td>		
		</tr> -->
			
		<tr>
		<td colspan='4'><?php echo $this->Form->submit(__('Filter Withdrawal Applicant'), array('name' => 'viewWithdrawal','class'=>'tiny radius button bg-blue', 'div' => false)); ?></td>
		</tr>
</table>
...
?>
	<div class="smallheading"><?php echo __('List of withdrawal applicant.');?></div>
	<?php 
...
<?php endforeach; ?>
	...
	echo $this->Form->submit('Accept/Reject Withdrawal',array('name'=>'saveIt','class'=>'tiny radius button bg-blue','div'=>'false')); 
