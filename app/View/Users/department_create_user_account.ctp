...
?>
<div class="smallheading"><?php echo __('Staff  List');?></div>
...
<table class="fs13 small_padding">
	...
	<tr>
		<td colspan="2"><?php echo $this->Form->Submit('Search',array('div'=>false,'class'=>'tiny radius button bg-blue','name'=>'search')); ?></td>	
	</tr>
	</table>
...
<table cellpadding="0" cellspacing="0">
	...
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			 <?php echo $this->Html->link(__('Create Account'), array('action' => 'department_create_user_account', $user['Staff']['id'])); ?> 
			 &nbsp;
...
if (isset($staff_account_valid)) {
?>
    <div class="smallheading"><?php echo __('Create User account for system access.'); 
     ?></div>
	...
	<?php
        ...
        echo '<td style="width:40%"><table><tbody>';
			...
			*/	
		       echo '<tr><td colspan=2 style="align:left">'.$this->Form->input('User.role_id',array('empty'=>'--select role--','id'=>'user_role_id','value'=>!empty($this->request->data['User']['role_id'])?$this->request->data['User']['role_id']:'')).'</td></tr>';	 
	...
	<tr><td><?php
                  ...
                  echo $this->Form->submit('Submit',array('name'=>'createAccount','class'=>'tiny radius button bg-blue','div'=>'false'));
