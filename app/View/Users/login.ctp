<?php echo ($this->Form->create('User', array('action' => 'login')));?>
 ...
 <div id="sign-up">
			<h3 class="color-blue-logo heading">Login To SIS</h3>
			<hr />
			...
			<label>Username</label>
			 ...
			 <?php echo($this->Form->input('username', array('placeholder'=>'Username','label'=>false, 'autocomplete' => "off",'id'=>'Text1'))); ?>
			<label>Password</label>
		   
			  <?php echo ($this->Form->input('password', array('label'=>false, 'autocomplete' => "off",'placeholder'=>'Password','id'=>"Text2"))); ?>
		   
			<?php echo($this->Form->Submit('Login', array('div' => false,'class'=>"blue-btn"))); ?>          
