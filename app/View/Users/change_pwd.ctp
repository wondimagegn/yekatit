...
?>
 ...
 <h6 style="text-align:center" class="box-title">
	     <?php echo __('Welcome to your SMiS Account'); ?>
	     </h6>
...
?>
 ...
 <h6 style="text-align:center" class="box-title">
	     <?php echo __('Your Account Password Is Reset'); ?>
	     </h6>
...
?>
 ...
 <h6 style="text-align:center" class="box-title">
	     <?php echo __('Time To Change Your Password'); ?>
	     </h6>
<?php
}
?>
...
<table class="fs12">
	...
	<tr>
		<td colspan="3"><?php echo $this->Form->end(array('label'=>'Change Password','class'=>'tiny radius button bg-blue'));?></td>
	</tr>
</table>
          </div>
	</div>
