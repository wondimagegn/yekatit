...
?></td></tr>
    ...
    <?php 
        ...
        echo "<table><tr><td>Check the college the user is responsible for</td></tr><tr><td>".$this->Form->input('StaffAssigne.college_id',array('multiple' => 'checkbox', 'value' => isset($college_id) ? $college_id :'', 'selected' =>isset($this->request->data['StaffAssigne']['college_id'])?$this->request->data['StaffAssigne']['college_id']:'','div'=>false))."
                   </td></tr></table>";
    ?>
