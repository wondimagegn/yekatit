    		...
    		<td background="/images/sc-diagonal-line.gif">
    			<table style="width:100%">
    				<tr>
    					...
    					<td style="text-align:center;font-weight:bold">'.(!empty($student_copy['student_detail']['University']) ? strtoupper($student_copy['student_detail']['University']['University']['name']) : 'Yekatit 12 Medical Hospital College').'</td>
...
if(isset($courses_and_grade['repeated_old']) && 
