...
App::import('Vendor','tcpdf/tcpdf');
	...
	<tr>
		...
		<td>'.$student_copy['Student']['full_name'].'</td>
		<td style="font-weight:bold">Program:</td>
		<td>'.$student_copy['Program']['name'].'</td>
	</tr>
	<tr>
...
<table style="width:100%">
	<tr>
		...
		<th style="border:1px solid #000000; width:5%">N<u>o</u></th>
		<th style="border:1px solid #000000; width:16%">Course Code</th>
		<th style="border:1px solid #000000; width:41%">Course Title</th>
		<th style="border:1px solid #000000; width:13%; text-align:center">'.(strcasecmp($student_copy['Curriculum']['type_credit'], 'Credit') == 0 ? 'Credit Hour' : 'ECTS').'</th>
		<th style="border:1px solid #000000; width:8%; text-align:center">Grade</th>
		<th style="border:1px solid #000000;  width:13%; text-align:center">Grade Point</th>
		<th rowspan="'.(count($student_copy['courses'])+2).'" style="width:2%"></th>
	</tr>';
$c_count = 0;
$credit_hour_sum = 0;
	...
	<tr>
		...
		<td style="width:48%">
			<table>
				...
				<tr>
					<td>Signature:</td>
					<td style="border-bottom:1px solid #000000">SMiS</td>
				</tr>
				<tr>
					<td>Date:</td>
