...
<table cellspacing="0" cellpadding="0" class="fs14">
	...
	<tr>
		<td colspan="6">
		<?php echo $this->Form->submit(__('Get Sections'), array('name' => 'listSections', 
...
if(isset($students_in_section) && empty($students_in_section)) {
	...
	<table>
		...
		foreach($students_in_section as $key => $student) {
			...
			<tr>
				<td><?php 
					echo $this->Form->input('Student.'.$st_count.'.gp', array('type' => 'checkbox','class'=>'checkbox1' ,'label' => false, 'id' => 'StudentSelection'.$st_count));
