...
<table class="low_padding_table fs13">
	...
	<tr>
		<td style="font-weight:bold"><?php echo (strpos(strtolower($student_copy['College']['name']), 'institute') !== false ? 'Institute' : 'School/Center'); ?>:</td>
...
?>
	<tr>
        ...
        id="<?php echo $c_count; ?>"><?php echo $this->Html->image('plus2.gif', array('id' => 'i'.$c_count)); ?></td>
