...
$(document).ready(function () {
	$("#PublishedCourse").change(function(){
		...
		if(pc.length > 1)
			window.location.replace("/exam_grades/<?php echo $this->request->action; ?>/"+pc[1]+"/section/"+$("#AcadamicYear").val()+"/"+$("#Semester").val());
		else
			window.location.replace("/exam_grades/<?php echo $this->request->action; ?>/"+pc[0]+"/pc/"+$("#AcadamicYear").val()+"/"+$("#Semester").val());
	});
});
...
<div class="smallheading"><?php echo __('Exam Grade View by Section');?></div>
