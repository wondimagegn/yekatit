<div class="box">
	<div class="box-header bg-transparent">
        <div class="box-title" style="margin-top: 10px;"><i class="fontello-edit" style="font-size: larger; font-weight: bold;"></i>
            <span style="font-size: medium; font-weight: bold; margin-top: 20px;"> <?= __('Edit Certification Course Setting'); ?></span>
        </div>
    </div>
    <div class="box-body">
    	<div class="row">
	  		<div class="large-12 columns">
				...
				<div class="programTypes form">
					<fieldset style="padding-top: 15px; padding-bottom: 0px;">
						...
						<hr>
						<?= $this->Form->end(array('label' => __('Save Setting'), 'name' => 'saveSetting', 'id' => 'addSetting', 'class' => 'tiny radius button bg-blue')); ?>
					</fieldset>
				</div>   
			</div>
		</div>
