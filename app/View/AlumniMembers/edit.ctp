                    ...
                    <div
                        ...
                        <div
                            ...
                            <div
								...
								echo $this->Form->input('gender', array(
									'options' => $options, 'type' => 'radio', 'legend' => false,
                        ...
                        <div
                            ...
                            <div
                                ...
                                <?php echo $this->Form->input('phone', array(
									'label' => '', 'id' => "phone", 'placeholder' => 'Phone',
									'required' => 'required'
								)); ?>
                            </div>
                            <div
                        ...
                        <div
                            ...
                            <div
                                ...
                                <label
                                    for="department">
                                    <?php
									echo __('Field of study'); ?>
                                </label>
                                <?php echo $this->Form->input('department', array(
									'label' => '', 'placeholder' => 'Field of study',
									'required' => 'required'
								)); ?>
                            </div>
                        ...
                        <div
                            ...
                            <div
                                class="large-4 columns">
                                <label
                                    for="name_of_employer">
                                    <?php
									echo __('Name of employer'); ?>
                                </label>
                                <?php echo $this->Form->input('name_of_employer', array(
									'label' => '', 'placeholder' => 'Name of employer',
									'required' => 'required'
								)); ?>
                            </div>
            ...
            <div class="box-body">
                <div class="row">
                    <div
                        ...
                        <div
                            class="alumniMembers form">
                            <?php echo $this->Form->create('AlumniMember'); ?>
                            <fieldset>
                                <legend>
                                    <?php echo __('Edit Alumni Member'); ?>
                                </legend>
                                <?php
								echo $this->Form->input('id');
                        ...
                        <div
                            ...
                            <ul>
                                ...
                                <li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('AlumniMember.id')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('AlumniMember.id')))); ?>
                                </li>
