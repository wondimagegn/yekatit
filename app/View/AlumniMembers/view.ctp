    ...
    <div class="box-body">
        <div class="row">
            <div
                ...
                <div
                    class="alumniMembers view">
                    <h2><?php echo __('Alumni Member'); ?>
                    </h2>
                    <dl>
                        <dt><?php echo __('Id'); ?>
                        </dt>
                        ...
                        <dt><?php echo __('Current Position'); ?>
                        </dt>
                        <dd>
                            <?php echo h($alumniMember['AlumniMember']['current_position']); ?>
                            &nbsp;
                        </dd>
                        <dt><?php echo __('Name Of Employer'); ?>
                        </dt>
                        <dd>
                ...
                <div class="actions">
                    ...
                    <ul>
                        <li><?php echo $this->Html->link(__('Edit Alumni Member'), array('action' => 'edit', $alumniMember['AlumniMember']['id'])); ?>
                        </li>
                        <li><?php echo $this->Form->postLink(__('Delete Alumni Member'), array('action' => 'delete', $alumniMember['AlumniMember']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $alumniMember['AlumniMember']['id']))); ?>
                        </li>
                        <li><?php echo $this->Html->link(__('List Alumni Members'), array('action' => 'index')); ?>
                        </li>
                        <li><?php echo $this->Html->link(__('New Alumni Member'), array('action' => 'add')); ?>
                        </li>
                    </ul>
                </div>
