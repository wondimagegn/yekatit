    ...
    <div class="box-body">
        <div class="row">
            <div
                ...
                <div
                    onclick="toggleViewFullId('ListAlumniMember')">
                    <?php
            ...
            <div
				...
				*/
                    ...
                    <div
                        class="large-4 columns">
                        <?php
						echo $this->Form->input('Search.department', array(
							'empty' => ' ',
            ...
            <div class="row">
                <div
                    class="large-12 columns">
                    <div
                        onclick="toggleViewFullId('ListStudents')">
                        <?php
						if (!empty($alumniMembers)) {
                ...
                <div class="large-12 columns"
                    id="ListStudents"
                    style="display:<?php echo (!empty($alumniMembers) ? 'none' : 'display'); ?>">
                    <div class="row">
                        <div
...
', array('label' => 'Country', 'type' => 'checkbox')); ?>
                        ...
                        <div
                            class="large-2 columns">
                            <?php echo $this->Form->input('Display.college', array('label' => 'Department', 'type' => 'checkbox')); ?>
                        </div>
                        <div
                            class="large-2 columns">
                            <?php echo $this->Form->input('Display.department', array('label' => 'Field of study', 'type' => 'checkbox')); ?>
                        </div>
                    </div>
                </div>
                <div
                ...
                <div
                    class="large-12 columns">
                    <div
                        class="alumniMembers index">
                        <h2><?php echo __('Alumni Members'); ?>
                        </h2>
                        <table
                            cellpadding="0"
                            cellspacing="0">
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <th><?php echo $this->Paginator->sort('institute_college'); ?>
                                    </th>
                                    <th><?php echo $this->Paginator->sort('department'); ?>
                                    </th>
                            ...
                            <tbody>
                                ...
                                <tr
                                    ...
                                    <td><?php echo h($alumniMember['AlumniMember']['full_name']); ?>
                                    </td>

                                    <td><?php echo h($alumniMember['AlumniMember']['email']); ?>
                                    </td>
                                    <td><?php echo h($alumniMember['AlumniMember']['gender']);  ?>
                                    </td>

                                    <td><?php
												echo h($alumniMember['AlumniMember']['institute_college']);
												?></td>
                                    <td><?php echo h($alumniMember['AlumniMember']['department']);  ?>
                                    </td>
                                    <td><?php echo h($alumniMember['AlumniMember']['program']); ?>
                                    </td>
