				...
				if (empty($colleagueLists)) { ?>
					<blockquote>
						...
						<p style="text-align:justify;">
							...
							<br>Not all staff members in your department are listed here; <b>only those who have been evaluated by students, have not yet been evaluated by you, are assigned to a course in the given academic year and semester, and whose evaluations remain unprinted</b> are included.
							</span>
						</p> 
					</blockquote>
					<?php
