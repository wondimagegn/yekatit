    ...
    <div class="box-body">
		...
		<dd<?php if ($i++ % 2 == 0) echo $class; ?>>
			...
			&nbsp;
                ...
                <div class="related">
                    <p class="fs15">
                        <?php echo __('Colleges in the Campus'); ?>
                    </p>
		...
		<th><?php echo __('Campus Id'); ?></th> -->
			...
			<td><?php echo $college['campus_id']; ?></td> --->
                            <td><?php echo $college['name']; ?>
                            </td>
                            <td><?php echo $college['description']; ?>
                            </td>
                            <td><?php echo $college['type']; ?>
                            </td>
                            <td
                                class="actions">
                                ...
                                <?php echo $this->Html->link(__('Delete'), array('controller' => 'colleges', 'action' => 'delete', $college['id']), null, sprintf(__('Are you sure you want to delete "%s" department?'), $college['name'])); ?>
                            </td>
                            </tr>
                            <?php endforeach; ?>
                    </table>
