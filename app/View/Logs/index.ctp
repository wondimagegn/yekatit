			...
			<td colspan="2" style="margin:0px; padding:0px">
				<table style="margin:0px; padding:0px">
					<tr>
						...
						<td style="border-bottom:0px; width:45%"><?php echo $this->Form->input('active', array('label' => 'Active User Account', 'type' => 'checkbox', 'checked' => (!isset($this->request->data['Log']['active']) || $this->request->data['Log']['active'] == 1 ? 'checked' : false))); ?></td>
						<td style="border-bottom:0px; width:50%"><?php echo $this->Form->input('deactive', array('label' => 'Non Active User Account', 'type' => 'checkbox', 'checked' => (!isset($this->request->data['Log']['deactive']) || $this->request->data['Log']['deactive'] == 1 ? 'checked' : false))); ?></td>
					</tr>
				</table>
			</td>
			<td>Description:</td>
