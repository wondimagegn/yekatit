       ...
       if (isset($coursesAdd) && !empty($coursesAdd)) {
         ...
         //  debug($student_section);
            ...
            foreach ($coursesAdd as $pk=>$pv) {
                ...
                //debug($pv);
                 echo "<tr><td>".++$count."</td><td>".$this->Form->checkbox('CourseRegistration.add.' . $pv['PublishedCourse']['id'])."</td><td>".$pv['Course']['course_title']."</td>";
                 echo "<td>".$pv['Course']['course_code']."</td>";
                 echo "<td>".$pv['Course']['lecture_hours']."</td>";
                 echo "<td>".$pv['Course']['tutorial_hours']."</td>";
                 echo "<td>".$pv['Course']['credit']."</td></tr>";
          ...
          //}
            ...
            array('div'=>false,'class'=>'tiny radius button bg-blue','name'=>'add'))."</td></tr>";
            echo  "</table>";
    }
 ...
 // debug($students);
  ...
  <table cellpadding="0" cellspacing="0">
	...
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('Add Course'), array('action' => 'add', $student['Student']['id'])); ?>
