...
<p class="fs16">
                    <strong> Important Note: </strong> 
                      ...
                      This tool will help you to add courses as mass that is published by
                      department as mass add.It is important when the course is a blocked
course or to correct missed  course from semester publication, mass course publication is 
the way to correct it. Mass course add is not considered as an add course for 
those sections which their department has published as mass add
rather it is part of the semester course
           ...
           $section_count++;
                if (!empty($coursss)) {
                   ...
                   <tr><th colspan=7><?php echo "Section: ".$sections[$section_id]; ?></td></tr>
                    <tr><th colspan=7><?php echo "Select the course you want to add mass add."; ?></td></tr>
                    <tr>
                    <?php 
            ...
            <tr>
              <?php if ($display_button!=$section_count) { ?>
                <td style='padding:0'> <?php 
                  echo $this->Form->submit('Mass Add',array('name'=>'massadd','class'=>'tiny radius button bg-blue','div'=>'false'));?></td>
