...
foreach($student_copies as $k=>$student_copy ) {
    ...
    <table style="width:100%; font-size:'.$font_size.'px">
    	<tr>
    		<td style="text-align:center; font-weight:bold">'.(!empty($student_copy['student_detail']['University']) ? strtoupper($student_copy['student_detail']['University']['University']['name']) : ' Yekatit 12 Hospital Medical College').'</td>
    	</tr>
    	<tr>
    		<td background="/images/sc-diagonal-line.gif">
    			<table style="width:100%">
    				...
    				<tr>
    					...
    					$student_copy['student_detail']['University']['University']['telephone'] : ''.$pobox.''). '  <br/>
                                Email:registrar@y12hmc.edu.et</td>
