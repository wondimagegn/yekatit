...
<div class="smallheading"><?php echo __('Graduation Certificate Printing');?></div>
<table class="fs13">
	<tr>
		...
		<td style="width:75%"><?php echo $this->Form->submit(__('Get Student Graduation Certificate'), array('name' => 'continueGraduationCertificatePrint','class'=>'tiny radius button bg-blue', 'div' => false)); ?></td>
	</tr>
</table>
<?php
if(!empty($graduation_certificate)) {
	...
	if(!empty($graduation_certificate_template)) {
		...
		echo $this->Form->submit(__('Display Student Graduation Certificate'), array('name' => 'displayGraduationCertificatePrint','class'=>'tiny radius button bg-blue', 'div' => false));
	}
}
echo $this->Form->end(); ?>
</div>
