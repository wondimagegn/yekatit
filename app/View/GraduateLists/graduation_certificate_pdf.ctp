...
//show header or footer
    ...
    $pdf->MultiCell(157, 7, 'OFFICE OF THE COLLEGE REGISTRAR', 0, 'L', false, 0, 27, 21);
...
/*
$this->MultiCell($w, $h, $html, $border, $align, $fill, $ln, $x, $y, $reseth, 0, true, $autopadding, 0, 'T', false);
*/
...
Fax '.$graduation_certificate['student_detail']['University']['University']['fax'].'
    ', 0, 'L', false, 0, 207, 31);
    $fontPath = $pdf->addTTFfont($_SERVER['DOCUMENT_ROOT'].'/app/Vendor/tcpdf/fonts/jiret.ttf');
...
$pdf->Image($_SERVER['DOCUMENT_ROOT'].'/app/webroot/img/centered-line-certificate.gif', 13, 65, 270, 5, '', '', '', false, 300, '', false, false, 0);
    ...
    $am_after_name = str_replace('SPECIALIZATION_DEGREE_NOMENCLATURE', '<u style="font-family:washra_bold;font-weight:bold;font-size:'.(($graduation_certificate_template['GraduationCertificate']['am_content_font_size']+2)*3).'px">'.$graduation_certificate['student_detail']['Curriculum']['specialization_amharic_degree_nomenclature'].'</u>', $am_after_name);

    $am_after_name = str_replace('DEGREE_NOMENCLATURE', '<u style="font-weight:bold;font-size:'.(($graduation_certificate_template['GraduationCertificate']['am_content_font_size']+2)*3).'px">'.$graduation_certificate['student_detail']['Curriculum']['amharic_degree_nomenclature'].'</u>', $am_after_name);


    $am_after_name = str_replace('GRADUATION_DATE', '<u style="font-family:washra;font-weight:bold;font-size:'.(($graduation_certificate_template['GraduationCertificate']['am_content_font_size']+2)*3).'px">'.$e_g_month_name.' '.$e_g_day.' ቀን '.$e_g_year.''.'</u>', $am_after_name);
    ...
    if(isset($en_c[1]))
    	...
    	$en_after_name = null;
    $en_after_name = str_replace('SPECIALIZATION_DEGREE_NOMENCLATURE', '<u style="font-family:times;font-weight:bold;font-size:'.(($graduation_certificate_template['GraduationCertificate']['en_content_font_size']*3)+3).'px">'.$graduation_certificate['student_detail']['Curriculum']['specialization_english_degree_nomenclature'].'</u>', $en_after_name);
    ...
    $en_after_name = str_replace('GRADUATION_DATE', '<u style="font-family:times;font-weight:bold;font-size:'.(($graduation_certificate_template['GraduationCertificate']['en_content_font_size']*3)+3).'px">'.$graduate_date.' G.C</u>', $en_after_name);
    $en_after_name = str_replace('STUDENT_CGPA', '<u style="font-family:times;font-weight:bold;font-size:'.(($graduation_certificate_template['GraduationCertificate']['en_content_font_size']*3)+3).'px">'.$graduation_certificate['student_detail']['StudentExamStatus']['cgpa'].'</u>', $en_after_name);
    $en_after_name = str_replace('STUDENT_MCGPA', '<u style="font-family:times;font-weight:bold;font-size:'.(($graduation_certificate_template['GraduationCertificate']['en_content_font_size']*3)+3).'px">'.(!empty($graduation_certificate['student_detail']['StudentExamStatus']['mcgpa']) ? $graduation_certificate['student_detail']['StudentExamStatus']['mcgpa'] : '-----').'</u>', $en_after_name);
...
<table style="width:100%;text-align:justify;">
	<tr>
		<td style="width:6%"></td>
		<td style="text-align:center; text-decoration:underline;width:42%; font-family:jiret; font-size:'.($graduation_certificate_template['GraduationCertificate']['am_title_font_size']*6).'px">'.$graduation_certificate_template['GraduationCertificate']['amharic_title'].'</td>
		<td style="width:5%"></td>
		<td style="text-align:center;font-weight:bold;text-decoration:underline; width:42%;line-height:5px;font-size:'.($graduation_certificate_template['GraduationCertificate']['en_title_font_size']*3+10).'px">'.$graduation_certificate_template['GraduationCertificate']['english_title'].'</td>
		<td style="width:5%"></td>
	</tr>
	<tr>
		<td></td>
	...
	<tr>
		...
		<td></td>
		<td style="text-decoration:underline;font-weight:bold; text-align:center; text-align:center; line-height:5px; font-size:'.(($graduation_certificate_template['GraduationCertificate']['en_content_font_size']*4)).'px">'.$graduation_certificate['student_detail']['Student']['full_name'].'</td>
		<td></td>
	</tr>
	<tr>
		<td colspan="5" style="height:5px; font-size:5px">&nbsp;</td>
	...
	<tr>
		<td></td>
		<td style="font-family:jiret; font-weight:bold;line-height:4px; font-size:'.($graduation_certificate_template['GraduationCertificate']['am_content_font_size']*3).'px">'.$am_after_name.'</td>
		<td></td>
		<td style="font-family:bookman_old_style;font-weight:bold; line-height:5px; font-size:'.($graduation_certificate_template['GraduationCertificate']['en_content_font_size']*3).'px">'.$en_after_name.'</td>
		<td></td>
	</tr>
</table>';
    $fontPath = $pdf->addTTFfont($_SERVER['DOCUMENT_ROOT'].'/app/Vendor/tcpdf/fonts/jiret.ttf');
