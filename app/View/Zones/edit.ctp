...
<div class="box">
	<div class="box-header bg-transparent">
		<div class="box-title" style="margin-top: 10px;"><i class="fontello-plus" style="font-size: larger; font-weight: bold;"></i>
			<span style="font-size: medium; font-weight: bold; margin-top: 20px;"> <?= 'Edit Zone: ' . (isset($this->data['Zone']['name']) ? $this->data['Zone']['name'] : '') . (isset($this->data['Zone']['short']) ? '  (' . $this->data['Zone']['short'] . ')' : ''); ?></span>
		</div>
	</div>
	<div class="box-body">
		<div class="row">
			...
			<div class="large-12 columns">
				<div class="large-6 columns">
					...
					echo $this->Form->input('region_id', array('style' => 'width:90%', 'empty' => '[ Select Region ]'));
					...
					echo $this->Form->input('short', array('style' => 'width:90%', 'placeholder' => 'Like: GAM', 'pattern' => '[A-Z]+', 'label' => 'Short Name (from MoE): <small></small></label><small class="error" style="width:90%; background: #fff; color:red; border-style: solid; border-width: thin; border-color: red; border-radius: 5px;">Zone short name must be a single word in all CAPS.</small>'));
					?>
				</div>
				<div class="large-6 columns">
					<?php
