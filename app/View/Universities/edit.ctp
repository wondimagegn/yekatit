...
<div class="box">
     <div class="box-header bg-transparent">
  	  <h6 class="box-title">
	     <?php echo __('Edit University Name'); ?>
	     </h6>
     </div>
     <div class="box-body">
       <div class="row">
	    <?php echo $this->Html->script('amharictyping'); ?>  
	 <?php echo $this->Form->create('University',array('action' => 'edit','enctype' => 'multipart/form-data'));?>
...
echo $this->Form->hidden('Attachment.1.id');
