...
$header = '<table style="width:100%;">
    	<tr>
    		<td style="text-align:center; font-weight:bold">' . Configure::read('CompanyName') . '</td>
    	</tr>
...
foreach ($onlineapplicant_list_pdf as $c_id => $students) {
  ...
  <tr>
		...
		<tr>
			...
			<td style="width:78%; font-weight:bold">' . $registrationDepartmentDetail[4] . '</td>
		</tr>
		';
...
*/
    ...
    $graduationCriteria .= '<tr><th style="width:5%;border:1px solid #000000; border-bottom:1px solid #000000;text-align:center ">S.No</th><th style="width:10%;text-align:center;border:1px solid #000000; border-bottom:1px solid #000000; ">ApplicationNumber</th><th style="width:15%;text-align:center;border:1px solid #000000; border-bottom:1px solid #000000; ">Student Name</th><th style="width:10%;text-align:center;border:1px solid #000000; border-bottom:1px solid #000000; ">Sex</th><th style="width:10%;text-align:center;border:1px solid #000000; border-bottom:1px solid #000000; ">GPA</th><th style="width:10%;text-align:center;border:1px solid #000000; border-bottom:1px solid #000000; ">Sponsor</th>
