<?php 
 if (isset($published_courses) && !empty ($published_courses)) {
            ...
            foreach ($published_courses as $pk=>$pv) {
                 ...
                 */
                 ...
                 echo "<tr><td>&nbsp;</td><td>".$count++."</td><td>".$pv['Course']['course_title']."**"."</td>";
                        ...
                        if(
                            $pv['PublishedCourse']['elective']==1 
                            ){
                       
                       echo "<tr ".$style.">";
                         if(isset($pv['prequisite_taken_passsed'])
                          && $pv['prequisite_taken_passsed']==0){
        ...
        $attributes=array('legend'=>false,'label'=>false,'separator'=>'<span>','default'=>1);
            
        echo '<tr><td>Are you ? </td> <td>'.$this->Form->radio('CourseRegistration.0.cafeteria_consumer',$options,$attributes).
        '</td></tr>';
            ...
            // dont show 
              ...
              echo "<tr><td colspan=7>".$this->Form->submit(__('Register'),
              array('name'=>'register','class'=>'tiny radius button bg-blue','div'=>false,
                'onclick'=>"this.disable=true;this.value='Submitting...';this.form.submit();"))."</td></tr>";
