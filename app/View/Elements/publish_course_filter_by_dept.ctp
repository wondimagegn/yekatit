...
<table cellspacing="0" cellpadding="0" class="fs14">
	...
	<tr>
		<td colspan="6">
		<?php echo $this->Form->submit(__(( isset($search_button_label) && !empty($search_button_label) ? $search_button_label : 'List Published Courses')), array('name' => 'listPublishedCourses','class'=>'tiny radius button bg-blue', 'div' => false)); ?>
		</td>
	</tr>
</table>
</div>
