...
if (isset($costSharingForInternal['StudentList']) && !empty($costSharingForInternal['StudentList'])) {
  $countColum=count($costSharingForInternal['CostSharingYearList'])*4+4+3+6;
 ...
 <table style="width:100%">
                ...
                <tr>
                  <td style="text-align:center;" colspan="<?php echo $countColum;?>" class="bordering2">Cost sharing  of <?php echo $this->request->data['Report']['graduated_academic_year'];?> Ac.Yr Admitted Students</td>
                ...
                <tr>
                    ...
                    <td rowspan="3" class="bordering2"> Field of Study</td> 
                      ...
                      <tr>
                  <?php foreach ($costSharingForInternal['CostSharingYearList'] 
                  as $ck=>$cvalue) { ?>
                  ...
                  as $ck=>$cvalue) { ?>
                   ...
                   <?php } ?>
                      ...
                      foreach($costSharingForInternal['StudentList'] as $cck=>$ccv) { 
                        ...
                        <tr>
                          ...
                          <?php 
                          foreach($costSharingForInternal['CostSharingYearList'] as $moek=>$moev){
                               if(isset($ccv[$moek])){
