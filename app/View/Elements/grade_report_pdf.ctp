		...
		foreach($student_copies as $key => $student_copy) {
			...
			<table style="width:100%">
				<tr>
					...
					<td  style="width:51%"><span style="font-weight:bold">' . (isset($student_copy['Section']['Department']['type']) ? $student_copy['Section']['Department']['type'] : 'Department') . ':</span> &nbsp;' . (!empty($student_copy['Section']['Department']['name']) ? $student_copy['Section']['Department']['name'] : (($student_copy['Program']['id'] == PROGRAM_REMEDIAL || $student_copy['Student']['program_id'] == PROGRAM_REMEDIAL) ? 'Remedial Program' : 'Pre/Freshman')) . '</td>
					<td style="width:2%">&nbsp;</td>
				</tr>
				<tr>
					<td>&nbsp;</td>
			...
			<table style="width:100%" cellpadding="1" class="table">
				<tr>
					...
					<th class="vcenter" style="font-weight: bold; border:1px solid #000000; vertical-align: middle; width:50%">&nbsp; Course Title</th>
					<th class="center" style="font-weight: bold; border:1px solid #000000; vertical-align: middle; width:8%; text-align:center">' . $type_credit . '</th>
					<th class="center" style="font-weight: bold; border:1px solid #000000; vertical-align: middle; width:8%; text-align:center">Grade</th>
					<th class="center" style="font-weight: bold; border:1px solid #000000;  vertical-align: middle; width:9%; text-align:center">GP</th>
			...
			// Add QR Code of student to verify on check graduates page
            $pdf->write2DBarcode(BASE_URL_HTTPS . 'pages/check_graduate/' . str_replace('/', '-', $student_copy['Student']['studentnumber']), 'QRCODE,H', 13, 246, 15, 15, $style = array(), 'N');
