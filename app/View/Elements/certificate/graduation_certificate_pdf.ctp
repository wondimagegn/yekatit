...
//show header or footer
    ...
    if ($graduation_certificate['student_detail']['Student']['graduated']) {
        ...
        $pdf->SetTitle('Graduation Certificate for ' .$graduation_certificate['student_detail']['Student']['full_name'] .' (' .$graduation_certificate['student_detail']['Student']['studentnumber'].')');
        $pdf->SetSubject($graduation_certificate['student_detail']['Student']['studentnumber']);
        $pdf->SetKeywords('Graduation, Certificate, '.$graduation_certificate['student_detail']['Student']['studentnumber'].', SMiS');
        ...
        */
        ...
        $pdf->MultiCell(100, 7, $e_month_name.' '.$e_day.'/'.$e_year.' ዓ/ም', 0, 'L', false, 0, 224, 40);
        ...
        */
        ...
        $am_after_name = str_replace('GRADUATION_DATE', '<u style="font-family: jiret; font-weight:bold; font-size:'.(($graduation_certificate_template['GraduationCertificate']['am_content_font_size']+2)*3).'px">'.$e_g_month_name.' <span style="font-family: freeserif; font-weight:bold; font-size:'.(($graduation_certificate_template['GraduationCertificate']['am_content_font_size'])*3).'px">'.$e_g_day.'</span> ቀን <span style="font-family: freeserif; font-weight:bold; font-size:'.(($graduation_certificate_template['GraduationCertificate']['am_content_font_size'])*3).'px">'.$e_g_year.'</span> ዓ/ም'.'</u>', $am_after_name);
        ...
        $en_after_name = str_replace('GRADUATION_DATE', '<u style="font-family:freeserif; font-weight:bold; font-size:'.(($graduation_certificate_template['GraduationCertificate']['en_content_font_size']*3)+3).'px">'.$graduate_date.' G.C</u>', $en_after_name);
    ...
    $pdf->Output('Graduation_Certificate_'.str_replace('/','-',$graduation_certificate['student_detail']['Student']['studentnumber']).'_'.$graduation_certificate['student_detail']['Student']['first_name'].'_'.$graduation_certificate['student_detail']['Student']['middle_name'].'_'.$graduation_certificate['student_detail']['Student']['last_name'].'_'.date('Y-m-d').'.pdf', 'I');
