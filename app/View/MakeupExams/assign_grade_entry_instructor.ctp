...
$(document).ready(function () {
	$("#PublishedCourse").change(function(){
		//serialize form data
		window.location.replace("/makeupExams/assign_grade_entry_instructor/"+$("#PublishedCourse").val());
	});
});
...
<table class="fs14">
	<tr>
		...
		<td style="width:70%"><?php echo $this->Form->input('MakeupExam.minute_number', array('label' => false, 'class' => 'fs14','value'=>'Inst. Grade Entry','readonly'=>'true','required')); ?></td>
	</tr>
</table>
...
echo $this->Form->submit(__('Assign Grade Entry'), array('name' => 'assignGradeEntryMakeupExam', 'div' => false,'class'=>'tiny radius button bg-blue')); 
}
}
?>
