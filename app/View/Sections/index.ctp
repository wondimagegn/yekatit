...
<div class="box">
	...
	<?php 
        ...
        echo '<tr><td colspan="6">'. $this->Form->Submit('Search',array('name'=>'search','div'=>false,
...
<?php if(isset($sections) && !empty($sections)) { ?>	
	...
	<tr<?php echo $class;?>>
		...
		<?php 
		if(0){
		echo $this->Html->link(__(''), array('action' => 'edit', $section['Section']['id']),array('class'=>'fontello-pencil','title'=>'Edit'));
		}
		 ?>
		
			<?php echo $this->Html->link(__(''), array('action' => 'view', $section['Section']['id']),array('class'=>'fontello-eye','title'=>'View')); ?>
			<?php echo $this->Html->link(__(''), array('action' => 'delete', $section['Section']['id']), array('class'=>'fontello-trash','title'=>'Delete'), sprintf(__('Are you sure you want to delete %s?'), $section['Section']['name'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
