<div class="box">
    <div class="box-header bg-transparent">
        <div class="box-title" style="margin-top: 10px;"><i class="fontello-edit" style="font-size: larger; font-weight: bold;"></i>
            <span style="font-size: medium; font-weight: bold; margin-top: 20px;"> <?= isset($this->request->data['Staff']['id']) && !empty($this->request->data['Staff']['id'])
                && isset($this->request->data['Staff']['full_name']) ? 'Update Staff Profile: ' . $this->request->data['Staff']['full_name'] :
                        __('Maintain Staff Profile'); ?></span>
        </div>
    </div>
    <div class="box-body">
        <div class="row">
            <div class="large-12 columns">
				...
				<?= $this->Form->create('Staff', array('type' => 'file', 'data-abide',  'enctype' => 'multipart/form-data')); ?>
				<?= $this->Form->hidden('id'); ?>
                ...
                <div class="row">
                    ...
                    <div class="large-4 columns">
                        <?= $this->Form->input('staffid', array('style' => 'width:100%;',
                                'type' => 'text', 'id' => 'staffid', 'label' => 'Staff ID: ')); ?>
                    </div>
                </div>
				<hr>
