<div class="box">
	<div class="box-header bg-transparent">
        <div class="box-title" style="margin-top: 10px;"><i class="fontello-plus" style="font-size: larger; font-weight: bold;"></i>
            <span style="font-size: medium; font-weight: bold; margin-top: 20px;"><?= 'Add Student Status Pattern'; ?></span>
        </div>
    </div>
    <div class="box-body">
    	<div class="row">
	  		<div class="large-12 columns">
				...
				<div class="studentStatusPatterns form">
					<fieldset style="padding-top: 15px; padding-bottom: 0px;">
						...
						<hr>
						<?= $this->Form->end(array('label' => __('Save'), 'class' => 'tiny radius button bg-blue')); ?>
					</fieldset>
				</div>
	  		</div>
		</div>
