<div class="box">
	<div class="box-header bg-transparent">
		<div class="box-title" style="margin-top: 10px;"><i class="fontello-edit" style="font-size: larger; font-weight: bold;"></i>
			<span style="font-size: medium; font-weight: bold; margin-top: 20px;"><?= __('Add Placement Round Participants'); ?></span>
		</div>
	</div>
	<div class="box-body">
		<div class="row">
							...
							<tbody>
								...
								if (empty($this->request->data)) { ?>
									<tr id="PlacementRoundType_1">
										...
										<td class="center"><?= $this->Form->input('PlacementRoundParticipant.1.type', array('label' => false, 'id' => 'PlacementType_1', 'options' => $types, 'style' => 'width:90%', 'onchange' => 'updateForeignKey("PlacementType_1","PlacementForeign_1")')); ?></td>
										<td class="center"><?= $this->Form->input('PlacementRoundParticipant.1.foreign_key', array('label' => false, 'id' => 'PlacementForeign_1', 'options' => $colleges, 'style' => 'width:90%', 'onchange' => 'displayUnit(this)')); ?></td>
										<td class="center"><?= $this->Form->input('PlacementRoundParticipant.1.name', array('label' => false, 'id' => 'name_1')); ?></td>
										<td class="center"><a href="javascript:deleteSpecificRow('PlacementRoundType_1')">Delete</a></td>
									</tr>
									<?php
								} else {
									$count = 1;
									foreach ($this->request->data['PlacementRoundParticipant'] as $key => $placementType) { ?>
										<tr id="PlacementRoundType_<?= $count; ?>">
											...
											<td style="padding-top:15px;" class="center"><a href="javascript:deleteSpecificRow('PlacementRoundType_<?= $count++; ?>')">Delete</a></td>
										</tr>
										<?php
									}
								} ?>
