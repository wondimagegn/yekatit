...
for ($i = 1; $i <= 12; $i++) {
    ...
    months[ < ? php echo $i - 1; ? > ][
            0] =
        "<?php echo date('m', mktime(0, 0, 0, $i, 1, 2011)); ?>";
    months[ < ? php echo $i - 1; ? > ][
            1] =
        "<?php echo date('F', mktime(0, 0, 0, $i, 1, 2011)); ?>"; <
    ? php
} ?
>
...
function updateRegionCity(id) {
    //serialize form data
    var formData = $("#country_id_" +
        id).val();

    $("#region_id_" + id).empty();
    $("#region_id_" + id).attr(
        'disabled', true);
    $("#city_id_" + id).attr('disabled',
        true);
    //get form action
    var formUrl =
...
function disabledOther(rowCount, id) {
    ...
    <div class="box-body pad-forty">
        <div class="row">
            <div
                ...
                <h4><?php echo __('Update Student Details'); ?>
                </h4>
            </div>
            <div
                class="large-12 columns">
                ...
                <ul class="tabs"
                    ...
                    <li
                        ...
                        <a
                            href="#basic_data">Personal
                            Data</a>
                    </li>
                    <li
                        class="tab-title">
                        <a
                            href="#add_address">Add
                            Address</a>
                    </li>
                    <li
                        class="tab-title">
                        <a
                            href="#education_background">Educational
                            Background</a>
                    </li>
                    <li
                        class="tab-title">
                                    ...
                                    <div
                                        ...
                                        <label>
											...
											if (empty($this->request->data['Student']['amharic_middle_name'])) {
												echo $this->Form->input('amharic_middle_name', array(
													'label' => false,
                                    ...
                                    <div
                                        ...
                                        <label>
											...
											if (empty($this->request->data['Student']['amharic_last_name'])) {
												...
												echo $this->Form->input('amharic_last_name', array(
													'label' => false,
 ...
 echo $this->Html->link(__('Name Spelling Error Correction', true),
		           ...
		           */
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <div
                                                class="large-12 columns">
                                                <?php
												echo $this->Form->input('place_of_birth', array('label' => 'Place of birth'));
												?>
                                            </div>
                                            <div
                                                class="large-12 columns">
                                                <?php
												echo $this->Form->input('citizenship', array('label' => 'Citizenship'));
												?>
                                            </div>
                                    ...
                                    <div
                                        ...
                                        <?php
										echo $this->Form->input('mother_tongue', array('label' => 'Native Language'));
										?>
                                    </div>
									...
									foreach ($this->request->data['Attachment'] as $ak => $av) {
										...
										if (!empty($av['dirname']) && !empty($av['basename']) && strcasecmp($av['dirname'], 'img') == 0) {
											...
											echo '<td>' . $this->Html->link(
												__('Delete Picture', true),
												array(
													'controller' => 'attachments', 'action' => 'delete',
													$av['id'], $action_controller_id
												),
												null,
												sprintf(__('Are you sure you want to delete picture ?', true))
											) . '</td>';
											echo '</tr>';
										} else {
...
width="144" class="profile-picture"></td></tr>';
								...
								echo "<tr><td> Department/School: " . $colleges[$this->data['Student']['college_id']] . "</td></tr>";

								if (!empty($this->data['Student']['department_id'])) {
									echo "<tr><td> Field of study:" . $departments[$this->data['Student']['department_id']] . '</td></tr>';
								} else {
									echo "<tr><td> Field of study:--- </td></tr>";
								}
                    ...
                    <div class="content"
						...
						echo '<tr><td>' . $this->Form->input('country_id', array(
							'id' => 'country_id_2', 'onchange' => 'updateRegionCity(2)', 'label' => 'Country', 'error' => false, 'empty' => false,
							'style' => 'width:250px', 'value' => 68
						)) . '</td></tr>';
						echo '<tr><td>' . $this->Form->input('region_id', array(
							'id' => 'region_id_2',
							'onchange' => 'updateCity(2)', 'label' => 'Region/City', 'error' => false, 'empty' => 'Select Country First', 'style' => 'width:250px'
						)) . '</td></tr>';
						...
						echo '<tr><td>' . $this->Form->input(
							'Contact.0.last_name',
							array('label' => 'Last Name')
						) . '</td></tr>';
						echo '<tr><td>' . $this->Form->input(
							'Contact.0.country_id',
							array('label' => 'Country', 'id' => 'country_id_1', 'value' => 68, 'style' => 'width:250px', 'onchange' => 'updateRegionCity(1)')
						) . '</td></tr>';
						echo '<tr><td>' . $this->Form->input(
							'Contact.0.region_id',
							array(
								'label' => 'Region', 'id' => 'region_id_1', 'onchange' => 'updateCity(1)',
								'style' => 'width:250px'
							)
						) . '</td></tr>';
						echo '<tr><td>' . $this->Form->input(
							'Contact.0.city_id',
							array('label' => 'City', 'id' => 'city_id_1', 'style' => 'width:250px')
						) . '</td></tr>';
						...
						echo '<tr><td>' . $this->Form->input(
							'Contact.0.alternative_email',
							array('label' => 'Alternative Email')
						) . '</td></tr>';

						echo '<tr><td>' . $this->Form->input(
							'Contact.0.phone_home',
							array('label' => 'Phone Home')
						) . '</td></tr>';

						echo '<tr><td>' . $this->Form->input(
							'Contact.0.phone_office',
							array('label' => 'Phone Office')
						) . '</td></tr>';

						echo '<tr><td>' . $this->Form->input(
							'Contact.0.phone_mobile',
						...
						echo '<tr><td>' . $this->Form->input(
							'Contact.0.primary_contact',
							array('label' => 'Primary Contact')
						) . '</td></tr>';
                    ...
                    <div class="content"
						...
						if (!empty($this->data['HighSchoolEducationBackground'])) {
							...
							foreach ($this->data['HighSchoolEducationBackground'] as $bk => $bv) {
								...
								echo "<td>" . $count . "</td><td>" .
									$this->Form->input(
										'HighSchoolEducationBackground.' . $bk . '.school_level',
										array('label' => false, 'div' => false, 'size' => 13)
									) .
									'</td><td>' .
									$this->Form->input(
										'HighSchoolEducationBackground.' . $bk . '.name',
										array('label' => false, 'div' => false, 'size' => 13)
									) . '</td>';
								...
								echo $this->Form->input(
									'HighSchoolEducationBackground.' . $bk . '.national_exam_taken',
								...
								echo '<td>' .
									$this->Form->input(
										'HighSchoolEducationBackground.' . $bk . '.town',
										array('label' => false, 'div' => false, 'size' => 13)
									) . '</td><td>' .
									$this->Form->input(
										'HighSchoolEducationBackground.' . $bk . '.zone',
										array('label' => false, 'div' => false, 'size' => 13)
									) . '</td><td>' .
									$this->Form->input(
										'HighSchoolEducationBackground.' . $bk . '.region_id',
							...
							echo "<tr><td>1</td><td>" . $this->Form->input(
								'HighSchoolEducationBackground.0.school_level',
								array(
							...
							echo '<td>';
							echo $this->Form->input(
								'HighSchoolEducationBackground.0.national_exam_taken',
								array('label' => false, 'div' => false)
							);
							echo '</td>';
							...
							echo '<td>' .
								$this->Form->input(
									'HighSchoolEducationBackground.0.town',
									array(
										'label' => false, 'div' => false, 'size' => 13
									)
								) . '</td><td>' .
								$this->Form->input(
									'HighSchoolEducationBackground.0.zone',
									array(
										'label' => false, 'div' => false, 'size' => 13
									)
								) . '</td><td>' .
								$this->Form->input(
									'HighSchoolEducationBackground.0.region_id',
									array('options' => $regions, 'type' => 'select', 'label' => false, 'empty' => '--select region--', 'style' => 'width:150px')
								) . '</td><td>' . '</td></tr>';
						?>
                 ...
                 <th>Second Degree</th>
						...
						if (!empty($this->data['HigherEducationBackground'])) {
							...
							foreach ($this->data['HigherEducationBackground'] as $bk => $bv) {
								...
								echo "<tr><td>" . $count . "</td><td>" . $this->Form->input(
									'HigherEducationBackground.' . $bk . '.name',
									array('label' => false, 'div' => false, 'size' => 13)
								) . '</td>';
								...
								echo '<td>' .
									...
									$this->Form->input(
										'HigherEducationBackground.' . $bk . '.field_of_study',
										array('label' => false, 'div' => false, 'size' => 13)
									) . '</td><td>' .
									$this->Form->input(
										'HigherEducationBackground.' . $bk . '.diploma_awarded',
										array('label' => false, 'div' => false, 'size' => 13)
									) . '</td><td>' .
									$this->Form->input(
										'HigherEducationBackground.' . $bk . '.cgpa_at_graduation',
										array('label' => false, 'div' => false, 'size' => 5)
									) . '</td>';

								echo "<td>" . $this->Form->input(
									'HigherEducationBackground.' . $bk . '.city',
									array('div' => false, 'label' => false, 'type' => 'text', 'size' => 13)
								) . "</td>";

								echo "<td>" . $this->Form->input(
									'HigherEducationBackground.' . $bk . '.first_degree_taken',
									array('div' => false, 'label' => false, 'type' => 'checkbox')
								) . "</td>";

								echo "<td>" . $this->Form->input(
									'HigherEducationBackground.' . $bk . '.second_degree_taken',
									array('div' => false, 'label' => false, 'type' => 'checkbox')
								) . "</td>";
							...
							echo "<td>" . $this->Form->input(
								...
								array('div' => false, 'label' => false, 'size' => 5)
							) . "</td>";
							echo "<td>" . $this->Form->input(
						...
						if (!empty($this->data['EheeceResult'])) {
							...
							foreach ($this->data['EheeceResult'] as $bk => $bv) {
								...
								echo "<tr><td>" . ++$count . "</td><td>" . $this->Form->input(
									'EheeceResult.' . $bk . '.subject',
									array(
										'name' => "data[EheeceResult][$bk][subject]",
										'value' => isset($this->data['EheeceResult'][$bk]['subject']) ?
											$this->data['EheeceResult'][$bk]['subject'] : '', 'div' => false, 'label' => false
									)
								) . "</td>";

								echo "<td>" . $this->Form->input(
									'EheeceResult.' . $bk . '.mark',
									array(
										'name' => "data[EheeceResult][$bk][mark]",
										'value' => isset($this->data['EheeceResult'][$bk]['mark']) ?
											$this->data['EheeceResult'][$bk]['mark'] : '', 'size' => 5, 'div' => false, 'label' => false
									)
								) . "</td>";


								echo "<td>" . $this->Form->input(
									'EheeceResult.' . $bk . '.exam_year',
									array(
										'name' => "data[EheeceResult][$bk][exam_year][]",
										'value' => !empty($this->data['EheeceResult'][$bk]['exam_year']) ?
											$this->data['EheeceResult'][$bk]['exam_year'] : '', 'div' => false, 'label' => false, 'dateFormat' => 'YM', 'maxYear' => date('Y'), 'orderYear' => 'desc'
									)
								) . "</td></tr>";
							...
							echo "<tr><td>1</td><td>" . $this->Form->input(
								'EheeceResult.0.subject',
								array(
									'name' => "data[EheeceResult][0][subject]",
									'value' => isset($this->data['EheeceResult'][0]['subject']) ?
										$this->data['EheeceResult'][0]['subject'] : '', 'div' => false, 'label' => false
								)
							) . "</td>";
							...
							echo "<td>" . $this->Form->input(
								'EheeceResult.0.mark',
								array(
									'name' => "data[EheeceResult][0][mark]",
									'value' => isset($this->data['EheeceResult'][0]['mark']) ?
										$this->data['EheeceResult'][0]['mark'] : '', 'size' => 5, 'div' => false, 'label' => false
								)
							) . "</td>";

							echo "<td>" . $this->Form->input(
								'EheeceResult.0.exam_year',
								array('name' => "data[EheeceResult][0][exam_year][]", 'label' => false, 'dateFormat' => 'YM', 'maxYear' => date('Y'), 'orderYear' => 'desc')
							) . "</td></tr>";
						}
						echo "</table>";
                            ...
                            <tr>
                                <td
                                    ...
                                    <INPUT
                                        type="button"
                                        value="Add Row"
                                        onclick="addRow('eheece_result','EheeceResult',3,'<?php echo  $eheece_all_fields; ?>','<?php echo $from; ?>')" />
                                    <INPUT
                                        type="button"
                                        value="Delete Row"
                                        onclick="deleteRow('eheece_result')" />
                                </td>
                            </tr>
                        </table>
                        <?php
						...
						if (!empty($this->data['EslceResult'])) {
							...
							foreach ($this->data['EslceResult'] as $bk => $bv) {
								...
								echo "<tr><td>" . ++$count . "</td><td>" . $this->Form->input(
									'EslceResult.' . $bk . '.subject',
									array(
										'name' => "data[EslceResult][$bk][subject]",
										'value' => isset($this->data['EslceResult'][$bk]['subject']) ?
											$this->data['EslceResult'][$bk]['subject'] : '', 'div' => false, 'label' => false
									)
								) . "</td>";

								echo "<td>" . $this->Form->input(
									'EslceResult.' . $bk . '.grade',
									array(
										'name' => "data[EslceResult][$bk][grade]",
										'value' => isset($this->data['EslceResult'][$bk]['grade']) ?
											$this->data['EslceResult'][$bk]['grade'] : '', 'size' => 4, 'div' => false, 'label' => false
									)
								) . "</td>";

								echo "<td>" . $this->Form->input(
									'EslceResult.' . $bk . '.exam_year',
									array(
										'value' => isset($this->data['EslceResult'][$bk]['exam_year']) ?
											$this->data['EslceResult'][$bk]['exam_year'] : '', 'div' => false, 'label' => false,
										'dateFormat' => 'YM', 'maxYear' => date('Y'), 'orderYear' => 'desc'
									)
								) . "</td></tr>";
							}
						} else {
							...
							echo "<tr><td>1</td><td>" . $this->Form->input(
								'EslceResult.0.subject',
								array(
									'name' => "data[EslceResult][0][subject]",
									'value' => isset($this->data['EslceResult'][0]['subject']) ?
										$this->data['EslceResult'][0]['subject'] : '', 'div' => false, 'label' => false
								)
							) . "</td>";
							...
							echo "<td>" . $this->Form->input(
								'EslceResult.0.grade',
								array(
									'name' => "data[EslceResult][0][grade]",
									'value' => isset($this->data['EslceResult'][0]['grade']) ?
										$this->data['EslceResult'][0]['grade'] : '', 'size' => 4, 'div' => false, 'label' => false
								)
							) . "</td>";

							echo "<td>" . $this->Form->input(
								'EslceResult.0.exam_year',
								array(
									'name' => "data[EslceResult][0][exam_year][]",
									'value' => isset($this->data['EslceResult'][0]['exam_year']) ?
										$this->data['EslceResult'][0]['exam_year'] : '', 'div' => false, 'label' => false, 'dateFormat' => 'YM', 'maxYear' => date('Y'), 'orderYear' => 'desc'
								)
							) . "</td></tr>";
						}
                            ...
                            <tr>
                                <td
                                    ...
                                    <INPUT
                                        type="button"
                                        value="Add Row"
                                        onclick="addRow('eslce_result','EslceResult',3,'<?php echo  $eslce_all_fields; ?>','<?php echo $from ?>')" />
                                    <INPUT
                                        type="button"
                                        value="Delete Row"
                                        onclick="deleteRow('eslce_result')" />
                                </td>
                            </tr>
                        </table>
                        <?php
                    ...
                    <div class="content"
                        ...
                        <div
							...
							$employment_all_fields = "";
							$sepp = "";
							foreach ($employment_fields as $key => $tag) {
								$employment_all_fields .= $sepp . $key;
								$sepp = ",";
							}
							echo '<div class="smallheading">Employment</div>';

							echo '<table id="employment_background"><tbody>';
							echo '<tr><th>No.</th><th>Are You Employed ?</th><th>Type of Job</th><th>Employer</th><th>Service Year</th><th>Pension Number</th><th>TIN </th><th>Office Phone</th><th>Email</th></tr>';
							if (!empty($this->data['Employment'])) {
								$count = 1;
								foreach ($this->data['Employment'] as $bk => $bv) {
									echo $this->Form->hidden('Employment.' . $bk . '.id');
									echo "<tr><td>" . $count . "</td><td>" . $this->Form->input('Employment.' . $bk . '.currently_employed', array(
										'label' => false, 'div' => false, 'size' => 13,
										'type' => 'checkbox',
										'onChange' => 'disabledOther(' . $bk . ',"Employment' . $bk . 'CurrentlyEmployed")'
									)) . '</td>';
									echo '<td>' . $this->Form->input('Employment.' . $bk . '.type_of_job', array('label' => false, 'div' => false, 'size' => 13)) . '</td>';

									echo '<td>' . $this->Form->input('Employment.' . $bk . '.employer', array('label' => false, 'div' => false, 'size' => 13)) . '</td>';

									echo '<td>' . $this->Form->input('Employment.' . $bk . '.service_year', array('label' => false, 'div' => false, 'size' => 13)) . '</td>';
									echo '<td>' . $this->Form->input('Employment.' . $bk . '.pension_number', array('label' => false, 'div' => false, 'size' => 13)) . '</td><td>' . $this->Form->input('Employment.' . $bk . '.tin', array('label' => false, 'div' => false, 'size' => 13)) . '</td>';
									echo '<td>' . $this->Form->input(
										'Employment.' . $bk . '.office_phone',
										array(
											'label' => false,
											'div' => false, 'size' => 5
										)
								...
								echo "<tr><td>1</td><td>" . $this->Form->input('Employment.0.currently_employed', array(
									'div' => false, 'label' => false,
									'type' => 'checkbox',

									'onChange' => 'disabledOther(0,this.id)'
								)) . "</td>";
								echo "<td>" . $this->Form->input('Employment.0.type_of_job', array('div' => false, 'disabled' => true, 'label' => false)) . "</td>";
								echo "<td>" . $this->Form->input('Employment.0.employer', array('div' => false, 'disabled' => true, 'label' => false)) . "</td>";
								echo "<td>" . $this->Form->input('Employment.0.service_year', array('div' => false, 'disabled' => true, 'label' => false)) . "</td>";

								echo "<td>" . $this->Form->input('Employment.0.pension_number', array('div' => false, 'disabled' => true, 'label' => false)) . "</td>";
								echo "<td>" . $this->Form->input(
									'Employment.0.tin',
									array('div' => false, 'disabled' => true, 'label' => false)
								) . "</td>";
								echo "<td>" . $this->Form->input(
									'Employment.0.office_phone',
									array('div' => false, 'disabled' => true, 'label' => false)
								) . "</td>";
								echo "<td>" . $this->Form->input(
									'Employment.0.email',
                                ...
                                <tr>
                                    <td
                                        ...
                                        <INPUT
                                            type="button"
                                            value="Add Row"
                                            onclick="addRow('employment_background','Employment',8,'<?php echo  $employment_all_fields; ?>')" />
                                        <INPUT
                                            type="button"
                                            value="Delete Row"
                                            onclick="deleteRow('employment_background')" />
                                    </td>
                                </tr>
                            </table>
                        </div>
                    ...
                    <div class="content"
                        ...
                        <div
							...
							$family_all_fields = "";
							$sepp = "";
							foreach ($family_fields as $key => $tag) {
								$family_all_fields .= $sepp . $key;
								$sepp = ",";
							}
							echo '<div class="smallheading">Family</div>';

							echo '<table id="family_background"><tbody>';
							echo '<tr><th>No.</th><th>Relationship ?</th><th>Full Name</th><th>Occuption</th><th>Education Level</th><th>Address</th><th>Cell Phone</th></tr>';
							if (!empty($this->data['Family'])) {
								$count = 1;
								foreach ($this->data['Family'] as $bk => $bv) {
									echo $this->Form->hidden('Family.' . $bk . '.id');
									echo "<tr><td>" . $count . "</td><td>" . $this->Form->input('Family.' . $bk . '.relationship', array(
										'label' => false, 'div' => false,
										'list' => 'relationshiplist', 'size' => 13
									)) . '</td>';
									echo '<td>' . $this->Form->input('Family.' . $bk . '.name', array('label' => false, 'div' => false, 'size' => 13)) . '</td>';
									echo '<td>' . $this->Form->input('Family.' . $bk . '.occupation', array('label' => false, 'div' => false, 'size' => 13)) . '</td>';

									echo '<td>' . $this->Form->input('Family.' . $bk . '.education_level', array('label' => false, 'div' => false, 'size' => 13)) . '</td>';

									echo '<td>' . $this->Form->input('Family.' . $bk . '.address', array('label' => false, 'div' => false)) . '</td>';
									echo '<td>' . $this->Form->input('Family.' . $bk . '.phone_mobile', array('label' => false, 'div' => false, 'size' => 13)) . '</td>';

									echo '</tr>';
									$count++;
								}
							} else {
								echo $this->Form->hidden('Family.0.id');
								echo "<tr><td>1</td><td>" . $this->Form->input('Family.0.relationship', array('div' => false, 'list' => 'relationshiplist', 'label' => false)) . "</td>";
								echo "<td>" . $this->Form->input('Family.0.name', array('div' => false, 'label' => false)) . "</td>";

								echo "<td>" . $this->Form->input('Family.0.occupation', array('div' => false, 'label' => false)) . "</td>";

								echo "<td>" . $this->Form->input('Family.0.education_level', array('div' => false, 'label' => false)) . "</td>";
								echo "<td>" . $this->Form->input('Family.0.address', array('div' => false, 'label' => false)) . "</td>";

								echo "<td>" . $this->Form->input('Family.0.phone_mobile', array('div' => false, 'label' => false)) . "</td>";
                                ...
                                <tr>
                                    <td
                                        ...
                                        <INPUT
                                            type="button"
                                            value="Add Row"
                                            onclick="addRow('family_background','Family',6,'<?php echo  $family_all_fields; ?>')" />
                                        <INPUT
                                            type="button"
                                            value="Delete Row"
                                            onclick="deleteRow('family_background')" />
                                    </td>
                                </tr>
                            </table>
                        </div>
                ...
                <?php echo $this->Form->end(array(
					'label' => __('Update Student Detail'),
...
<div class="row">
    <div class="large-12 columns">
        <div id="myModalChangeName"
            class="reveal-modal"
            data-reveal>

        </div>

        <div id="myModalCorrectName"
            class="reveal-modal"
            data-reveal>

        </div>

        <div id="myModalAddFamily"
            class="reveal-modal"
            data-reveal>

        </div>

        <div id="myModalAddEmployment"
            class="reveal-modal"
            data-reveal>
