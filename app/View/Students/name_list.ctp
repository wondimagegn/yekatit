            ...
            <div
                ...
                <table cellspacing="0"
                    ...
                    <tr>
                        ...
                        <td
                            style="width:25%">
                            <?php echo $this->Form->input('program_id', array('id' => 'Program', 'class' => 'fs13', 'label' => false, 'type' => 'select', 'options' => $programs, 'default' => $default_program_id)); ?>
                        </td>
                        <td
                            style="width:11%">
                            Program
                        ...
                        <td
                            style="width:53%">
                            <?php echo $this->Form->input('program_type_id', array('id' => 'ProgramType', 'class' => 'fs13', 'label' => false, 'type' => 'select', 'options' => $program_types, 'default' => $default_program_type_id)); ?>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td
                            style="width:20%">
                            <?php echo $this->Form->input('admission_year', array('id' => 'AcadamicYear', 'label' => false, 'class' => 'fs14', 'style' => 'width:125px', 'type' => 'select', 'options' => $acyear_array_data, 'default' => (isset($academic_year_selected) ? $academic_year_selected : $defaultacademicyear))); ?>
                        </td>

                        <td>Field of
                            study:</td>
                        <td><?php echo $this->Form->input('department_id', array('id' => 'ProgramType', 'class' => 'fs13', 'label' => false, 'type' => 'select', 'options' => $departments, 'default' => $default_department_id)); ?>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>Name:</td>
                        <td><?php echo $this->Form->input('name', array('id' => 'name', 'class' => 'fs14', 'label' => false)); ?>
                        </td>

                        <td>Student ID:
                        </td>
                        <td><?php echo $this->Form->input('studentnumber', array('id' => 'name', 'class' => 'fs14', 'label' => false)); ?>
                        </td>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
							...
							if (!empty($students_for_name_list)) {
								...
								echo $this->Form->submit(__('View PDF', true), array(
									'name' => 'viewPDF', 'div' => false,
                ...
                <table cellpadding="0"
                    ...
                    <tr>
                        ...
                        <th><?php echo $this->Paginator->sort('full_am_name'); ?>
                        </th>
                        ...
                        <th><?php echo $this->Paginator->sort('College'); ?>
                        </th>
                        <th><?php echo $this->Paginator->sort('Department', 'department_id'); ?>
                        </th>
                        <th
                            class="actions">
                            <?php __('Actions'); ?>
                    ...
                    <tr<?php echo $class; ?>>
                        ...
                        <td><?php echo $student['Student']['full_am_name']; ?>&nbsp;
                        </td>
