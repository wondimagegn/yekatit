<script>
var card_number =
    "<?php echo !empty($students['Student']['card_number']) ? $students['Student']['card_number'] : "
"; ?>";
...
function confirmCardNumberchange() {
    if (card_number != "") {
        ...
        .val() != "") {
            return confirm(
                'Are you sure you want to change student card number?'
                );
        }
    }
}
...
<div class="students form">
    ...
    <div class="smallheading">
        <?php echo __('Manage Student Medical Card Number'); ?>
    </div>
    ...
    <table cellpadding="0"
        ...
        <tr>
            ...
            <th><?php echo ('Card Number'); ?>
            </th>
            <th><?php echo ('Gender'); ?>
            </th>
            <th><?php echo ('BirthDay'); ?>
            </th>
            <th><?php echo ('Program'); ?>
            </th>
            <th><?php echo ('ProgramType'); ?>
            </th>
        ...
        <tr>
            ...
            <td><?php echo !empty($students['Student']['card_number']) ? $students['Student']['card_number'] : "---"; ?>&nbsp;
            </td>
            <td><?php echo $students['Student']['gender']; ?>&nbsp;
            </td>
            <td><?php echo !empty($students['Student']['birthdate']) ? '<u>' . $students['Student']['birthdate'] . '</u>' : "---"; ?>&nbsp;
            </td>
            <td><?php echo $students['Program']['name']; ?>&nbsp;
            </td>
            <td><?php echo $students['ProgramType']['name']; ?>&nbsp;
            </td>
            <td><?php echo $students['College']['name']; ?>&nbsp;
            </td>
            <td><?php echo $students['Department']['name']; ?>&nbsp;
            </td>
