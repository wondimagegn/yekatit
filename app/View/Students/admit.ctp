...
<div class="students form"
    ...
    <table cellpadding="0"
            ...
            <td>
                <?php
					if (!empty($college_level)) {
						echo $this->Form->input('AcceptedStudent.college_id', array('label' => 'Select Department', 'type' => 'select', 'empty' => '---Select Department --'));
					}
					if (!empty($department_level)) {
						echo $this->Form->input('AcceptedStudent.department_id', array('label' => 'Select Field of study/specialization', 'type' => 'select', 'empty' => '---Select Field of study/specialization --'));
					}
        ...
        <tr>
            <td><?php echo $this->Form->Submit('Search', array('div' => false, 'name' => 'getacceptedstudent', 'class' => 'tiny radius button bg-blue')); ?>
            </td>
        </tr>
    </table>
    <?php } ?>
                ...
                <td>
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <th><?php echo $this->Paginator->sort('Student Number', 'studentnumber'); ?>
                            </th>

                            <th><?php echo $this->Paginator->sort('EHEECE Result', 'EHEECE_total_results'); ?>
                            </th>
                            <th><?php echo $this->Paginator->sort('Department Name', 'college_id'); ?>
                            </th>
                            <th><?php echo $this->Paginator->sort('Field of study', 'department_id'); ?>
                            </th>
                            <th><?php echo $this->Paginator->sort('Program Type', 'program_type_id'); ?>
                            </th>
                            <th><?php echo $this->Paginator->sort('Academic Year', 'academicyear'); ?>
                            </th>
                            <th><?php echo $this->Paginator->sort('Department Approved', 'Placement_Approved_By_Department'); ?>
                            </th>
                        ...
                        <tr<?php echo $class; ?>>
                            ...
                            <td><?php echo $acceptedStudent['AcceptedStudent']['Placement_Approved_By_Department'] == 1 ? 'Approved' : 'Not Approved'; ?>&nbsp;
                            </td>
...
?>
    ...
    <?php echo $this->Form->create('Student', array(
		'type' => 'file', 'class' => 'ajax_page',
		'action' => 'admit'
	)); ?>

    <div class="headerfont">
        <?php echo __('Admit Student'); ?>
    </div>
    <div id="basic_fields"
        style="display:block">
        <?php
		...
		echo '<tr><td>' . $this->Form->input(
			...
			array('options' => array(
				...
				'divorced' => 'Divorced', 'windowed' => 'Windowed'
		...
		echo "<tr><td> Department: " . $colleges[$this->request->data['Student']['college_id']] . "</td></tr>";

		if (!empty($this->request->data['Student']['department_id'])) {
			echo "<tr><td> Field of study:" . $departments[$this->request->data['Student']['department_id']] . '</td></tr>';
		} else {
    ...
    <div id="education_background"
		...
		if (!empty($this->request->data['HighSchoolEducationBackground'])) {
			...
			foreach ($this->request->data['HighSchoolEducationBackground'] as $bk => $bv) {
				...
				echo '<td>' .
					...
					$this->Form->input(
						...
						array('options' => $regions, 'type' => 'select', 'label' => false, 'empty' => '--select region--')
					) . '</td><td>' . '</td></tr>';
				$count++;
			}
		} else {
			echo "<tr><td>1</td><td>" . $this->Form->input(
				...
				array(
					'value' => isset($this->request->data['HighSchoolEducationBackground'][0]['school_level']) ? $this->request->data['HighSchoolEducationBackground'][0]['school_level'] : '', 'label' => false, 'div' => false, 'size' => 13
				)
			) . '</td><td>' .
				$this->Form->input(
		...
		if (!empty($this->request->data['HigherEducationBackground'])) {
			...
			foreach ($this->request->data['HigherEducationBackground'] as $bk => $bv) {
				echo "<tr><td>" . $count . "</td><td>" . $this->Form->input(
					...
					$this->Form->input(
						'HigherEducationBackground.' . $bk . '.date_graduated',
						array('label' => false, 'type' => 'text', 'div' => false)
					) . '</td><td>' .
					$this->Form->input(
						'HigherEducationBackground.' . $bk . '.cgpa_at_graduation',
						array('size' => 4, 'label' => false, 'div' => false)
					) . '</td></tr>';
				$count++;
			}
		} else {
        ...
        <TR>
            ...
            <TD> <INPUT type="text"
                    size="13"
                    name="data[HigherEducationBackground][0][name]" />
            </TD>
            <TD> <INPUT type="text"
                    size="13"
                    name="data[HigherEducationBackground][0][field_of_study]" />
            </TD>
            <TD> <INPUT type="text"
                    size="13"
                    name="data[HigherEducationBackground][0][diploma_awarded]" />
            </TD>
            <TD> <INPUT type="text"
                    size="13"
                    name="data[HigherEducationBackground][0][date_graduated]" />
            </TD>
            <TD> <INPUT type="text"
                    size="13"
                    name="data[HigherEducationBackground][0][cgpa_at_graduation]" />
            </TD>
        ...
        <table>
            <tr>
                <td colspan=6>
                    <INPUT type="button"
                        value="Add Row"
                        onclick="addRow('higher_education_background','HigherEducationBackground',5,'<?php echo  $higher_all_fields; ?>')" />
                    <INPUT type="button"
                        value="Delete Row"
		...
		if (!empty($this->request->data['EheeceResult'])) {
				...
				echo "<tr><td>" . ++$count . "</td><td>" . $this->Form->input(
					...
					array(
						...
						'value' => isset($this->request->data['EheeceResult'][$bk]['subject']) ?
							$this->request->data['EheeceResult'][$bk]['subject'] : '', 'div' => false, 'label' => false
					)
				) . "</td>";
				...
				echo "<td>" . $this->Form->input(
					...
					array(
						...
						'value' => isset($this->request->data['EheeceResult'][$bk]['mark']) ?
							$this->request->data['EheeceResult'][$bk]['mark'] : '', 'size' => 5, 'div' => false, 'label' => false
					)
				) . "</td>";
				...
				echo "<td>" . $this->Form->input(
					...
					array(
						...
						'selected' => !empty($this->request->data['EheeceResult'][$bk]['exam_year']) ?
							$this->request->data['EheeceResult'][$bk]['exam_year'] : ''
					)
				) . "</td></tr>";
			}
		} else {
			echo "<tr><td>1</td><td>" . $this->Form->input(
				...
				array(
					...
					'value' => isset($this->request->data['EheeceResult'][0]['subject']) ?
						$this->request->data['EheeceResult'][0]['subject'] : '', 'div' => false, 'label' => false
				)
			) . "</td>";
			...
			echo "<td>" . $this->Form->input(
				...
				array(
					...
					'value' => isset($this->request->data['EheeceResult'][0]['mark']) ?
						$this->request->data['EheeceResult'][0]['mark'] : '', 'size' => 5, 'div' => false, 'label' => false
				)
			) . "</td>";
			...
			echo "<td>" . $this->Form->input(
				...
				array(
					'name' => "data[EheeceResult][0][exam_year]", 'div' => false, 'label' => false,
					'type' => 'select', 'options' => $yearoptions, 'empty' => '--select year--'
				)
			) . "</td></tr>";
		}
		echo "</table>";
		...
		if (!empty($this->request->data['EslceResult'])) {
			...
			foreach ($this->request->data['EslceResult'] as $bk => $bv) {
				echo "<tr><td>" . ++$count . "</td><td>" . $this->Form->input(
					...
					array(
						...
						'value' => isset($this->request->data['EslceResult'][$bk]['subject']) ?
							$this->request->data['EslceResult'][$bk]['subject'] : '', 'div' => false, 'label' => false
					)
				) . "</td>";
				...
				echo "<td>" . $this->Form->input(
					...
					array(
						...
						'value' => isset($this->request->data['EslceResult'][$bk]['grade']) ?
							$this->request->data['EslceResult'][$bk]['grade'] : '', 'size' => 4, 'div' => false, 'label' => false
					)
				) . "</td>";
				...
				echo "<td>" . $this->Form->input(
					...
					array(
						'value' => isset($this->request->data['EslceResult'][$bk]['exam_year']) ?
						...
						'type' => 'select', 'options' => $yearoptions, 'selected' => !empty($this->request->data['EslceResult'][$bk]['exam_year']) ?
							$this->request->data['EslceResult'][$bk]['exam_year'] : ''
					)
				) . "</td></tr>";
			}
		} else {
			echo "<tr><td>1</td><td>" . $this->Form->input(
				...
				array(
					...
					'value' => isset($this->request->data['EslceResult'][0]['subject']) ?
						$this->request->data['EslceResult'][0]['subject'] : '', 'div' => false, 'label' => false
				)
			) . "</td>";
			...
			echo "<td>" . $this->Form->input(
				...
				array(
					...
					'value' => isset($this->request->data['EslceResult'][0]['grade']) ?
						$this->request->data['EslceResult'][0]['grade'] : '', 'size' => 4, 'div' => false, 'label' => false
				)
			) . "</td>";
    ...
    <div id="add_address"
		...
		echo '<tr><td>' . $this->Form->input('country_id', array(
			'id' => 'country_id_2', 'onchange' => 'updateRegionCity(2)', 'label' => 'Country', 'error' => false, 'empty' => false, 'value' => 68,
			'style' => 'width:250px'
		)) . '</td></tr>';
		echo '<tr><td>' . $this->Form->input('region_id', array(
			'id' => 'region_id_2',
			'onchange' => 'updateCity(2)', 'label' => 'Region/City', 'style' => 'width:250px', 'error' => false, 'empty' => 'Select Country First'
		)) . '</td></tr>';
		...
		echo '<tr><td>' . $this->Form->input(
			...
			array('label' => 'Country', 'style' => 'width:250px', 'id' => 'country_id_1', 'value' => 68, 'onchange' => 'updateRegionCity(1)', 'style' => 'width:250px')
		) . '</td></tr>';
		echo '<tr><td>' . $this->Form->input(
			'Contact.0.region_id',
			array(
		...
		echo '<tr><td>' . $this->Form->input(
			'Contact.0.city_id',
			array(
				'label' => 'City', 'style' => 'width:250px', 'id' => 'city_id_1',
				'style' => 'width:250px'
			)
		) . '</td></tr>';
		...
		echo '</div>'; // End add tab div
		echo $this->Js->get('#StudentCountryId')->event(
			'change',
		...
		echo $this->Js->get('#StudentRegionId')->event(
			'change',
			$this->Js->request(array(
				'controller' => 'students',
				'action' => 'get_cities'
