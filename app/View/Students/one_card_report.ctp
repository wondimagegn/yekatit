                    ...
                    <div id="ListPublishedCourse"
                        ...
                        <table
                            ...
                            <tr>
                                ...
                                <td><?php echo $this->Form->input('report_type', array('label' => false, 'type' => 'select', 'style' => 'width:200px', 'div' => false, 'empty' => 'Select Report Type', 'onchange' => 'toggleFields("reportType")', 'options' => $report_type_options, 'id' => 'reportType')); ?>
                                    <span
                                        style="font-size:11px"></span>
                                </td>
                                <?php if (
									isset($this->data['Report']['report_type'])
                                ...
                                <td
                                    style="width:53%;">
                                    <?php echo $this->Form->input('top', array(
											'id' => 'Top',
                                ...
                                <td class="notVisibleOnAttritionRate"
                                    style="display:none;width:11%">
                                    Top:
                                </td>
                                <td class="notVisibleOnAttritionRate"
                                    style="display:none;width:53%;">
                                    <?php echo $this->Form->input('top', array(
											'id' => 'Top',
                            ...
                            <tr>
                                ...
                                <td
                                    style="width:25%">
                                    <?php echo $this->Form->input('department_id', array('id' => 'ProgramType', 'class' => 'fs14', 'style' => 'width:300px', 'label' => false, 'type' => 'seSlect', 'options' => $departments, 'default' => $default_department_id)); ?>
                                </td>
                                <td
                                    style="width:11%">
                                    Year
                                ...
                                <td
                                    style="width:53%">
                                    <?php echo $this->Form->input('year_level_id', array('id' => 'YearLevel', 'class' => 'fs13', 'label' => false, 'type' => 'select', 'options' => $yearLevels, 'default' => $default_year_level_id)); ?>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td
                                    style="width:20%">
                                    <?php echo $this->Form->input('acadamic_year', array('id' => 'AcadamicYear', 'label' => false, 'class' => 'fs14', 'style' => 'width:125px', 'type' => 'select', 'options' => $acyear_array_data, 'default' => (isset($academic_year_selected) ? $academic_year_selected : $defaultacademicyear))); ?>
                                </td>
                                <td
                                    style="width:15%">
                                    Semester:
                                ...
                                <td
                                    style="width:50%">
                                    <?php echo $this->Form->input('semester', array('id' => 'Semester', 'class' => 'fs14', 'type' => 'select', 'style' => 'width:125px', 'label' => false, 'options' => array('I' => 'I', 'II' => 'II', 'III' => 'III'), 'default' => (isset($semester_selected) ? $semester_selected : false))); ?>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td
                                    style="width:25%">
                                    <?php echo $this->Form->input('program_id', array('id' => 'Program', 'class' => 'fs14', 'label' => false, 'type' => 'select', 'options' => $programs, 'default' => $default_program_id)); ?>
                                </td>
                                <td
                                    style="width:12%">
                                    Program
                                ...
                                <td
                                    style="width:53%">
                                    <?php echo $this->Form->input('program_type_id', array('id' => 'ProgramType', 'class' => 'fs14', 'label' => false, 'type' => 'select', 'options' => $program_types, 'default' => $default_program_type_id)); ?>
                                </td>
                            </tr>

                            <tr
                                class="gradeChangeState">
                                <td> Region:
                                </td>
                                ...
                                <td><?php echo $this->Form->input('gender', array(
										...
										'options' => array('all' => 'All', 'female' => 'Female', 'male' => 'Male')
									)); ?></td>
                            </tr>
                            <tr class="academicStatus notVisibleOnAttritionRate"
                                style="<?php isset($showFromToBlock) && !empty($showFromToBlock) ? 'display:block;' : 'display:none;' ?>">
                                <td
                                    style="width:10%">
                                    Academic
                                    Status
                                ...
                                <td
                                    style="width:25%">
                                    <?php echo $this->Form->input('gpa', array(
										'label' => false,
                            ...
                            <tr>
                                ...
                                <td class="visibleOnDistribution"
                                    colspan="2">
                                    Graph
                                    Type:
                                </td>
...
function toggleFields(id) {
    ...
    if ($("#" + id).val() ==
        ...
        $(".notVisibleOnAttritionRate ")
            .hide();
    } else if (($('#' + id).val() ==
            'distributionStatsGender' ||
            $('#' + id).val() ==
