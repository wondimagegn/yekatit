    ...
    <div class="box-body">
        <div class="row">
            <div
                ...
                <div id="LisAdmittedStudent"
                    ...
                    <table
                        ...
                        <tr>
                            ...
                            <td
                                style="width:25%"><?php echo $this->Form->input('Search.currentAcademicYear', array(
                            ...
                            <td
                                style="width:53%"><?php
													echo $this->Form->input('Search.semester', array('label' => false, 'options' => array(
														'I' => 'I', 'II' => 'II',
														'III' => 'III'
													))); ?>
                            </td>
                ...
                <div
                    class="smallheading">
                    <?php echo  __('Select List of student you want to allow or deny cafe entry.'); ?>
                </div>
                <table cellspacing="0"
                    cellpadding="0">
                    ...
                    <tr>
                        <td colspan="7">
                            <span>What
                                ...
                                do ?
                                <?php
																			echo $this->Form->input('Search.allow', array('label' => false, 'options' => array('1' => 'Allow', '0' => 'Deny'))); ?>
                            </span></td>
                    ...
                    <tr<?php echo $class; ?>>
                        ...
                        <td><?php echo $this->Form->checkbox('Student.approve.' . $acceptedStudent['Student']['id'], array('class' => 'checkbox1')); ?>
                        </td>

                        <td><?php echo $acceptedStudent['Student']['full_name']; ?>&nbsp;
                        </td>
                        <td><?php echo $acceptedStudent['Student']['gender']; ?>&nbsp;
                        </td>
                        <td><?php echo $acceptedStudent['Student']['studentnumber']; ?>&nbsp;
                        </td>
                        <td><?php echo $acceptedStudent['Student']['ecardnumber']; ?>&nbsp;
                        </td>
						...
						echo '<tr><td colspan="7">' . $this->Form->Submit('Push To Cafe Gate', array(
							'div' => false, 'name' => 'pushStudentsToCafeGate',
