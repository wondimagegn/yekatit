...
foreach ($studentsList as $k => $student_detail) {
     ...
     $pdf->Image($_SERVER['DOCUMENT_ROOT'] . '/app/webroot/img/border-background-images-id-card.png', 3, 3, 580, 400, $bg_mime, '', '', false, 600, 'C', false, false, 0);
    ...
    */
     ...
     if (!empty($student_detail['Department']['name'])) {
          $pdf->MultiCell(400, 10, "Field of study:", 0, 'L', false, 0, 105, 120);
     ...
     $pdf->MultiCell(400, 10, "የት/ት መስክ:", 0, 'L', false, 0, 105, 130);
     $pdf->SetFont($fontPath, '', 15, '', true);
