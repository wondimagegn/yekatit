            ...
            <div
                ...
                <div id="UpdateKoha"
                    ...
                    <table
                        ...
                        <tr>
                            ...
                            <td><?php echo $this->Form->input('Search.name', array('label' => false)); ?>
                            </td>
                            <td></td>
                            <td></td>
                        </tr>
                ...
                <table cellpadding="0"
                    ...
                    <tr<?php echo $class; ?>>
                        ...
                        <td><?php echo $this->Form->checkbox('AcceptedStudent.approve.' . $acceptedStudent['Student']['id'], array('class' => 'checkbox1')); ?>&nbsp;
                        </td>
