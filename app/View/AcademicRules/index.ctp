                ...
                <div
                    ...
                    <table
                        ...
                        <tr>
                            ...
                            <th><?php echo $this->Paginator->sort('from'); ?>
                            </th>
                            <th><?php echo $this->Paginator->sort('to'); ?>
                            </th>
						...
						?>
                        <tr<?php echo $class; ?>>
                            <td><?php echo $academicRule['AcademicRule']['id']; ?>&nbsp;
                            </td>
                            <td><?php echo $academicRule['AcademicRule']['name']; ?>&nbsp;
                            </td>
                            <td><?php echo $academicRule['AcademicRule']['from']; ?>&nbsp;
                            </td>
                            <td><?php echo $academicRule['AcademicRule']['to']; ?>&nbsp;
                            </td>
                            <td><?php echo $academicRule['AcademicRule']['created']; ?>&nbsp;
                            </td>
                            <td><?php echo $academicRule['AcademicRule']['modified']; ?>&nbsp;
                            </td>
                            <td
                                class="actions">
