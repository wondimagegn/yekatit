...
<p class="fs16">
                    <strong> Important Note: </strong> 
                      ...
                      This tool will help you to register the selected course.
                ...
                if (!empty($coursss)) {
                   ...
                   <tr><th colspan=7><?php echo "Section: ".$sections[$section_id]; ?></td></tr>
                    ...
                    foreach ($coursss as $kc=>$vc) {
						...
						echo '<td>'.$this->Form->checkbox('PublishedCourse.'.$section_id.'.'.$vc['PublishedCourse']['id'],array('class'=>'listOfPublishedCourse','id'=>$count)).'</td>';
                        }
            ...
            <?php      
             ...
             ?>
				...
				<td style='padding:0'> <?php 
				  echo $this->Form->submit('Register for Selected Course',array('name'=>'registerIndivdualCourse',
