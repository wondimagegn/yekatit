<div class="journals index">
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $journal['Journal']['title']; ?>&nbsp;</td>
		<td><?php echo $journal['Journal']['created']; ?>&nbsp;</td>
		<td><?php echo $journal['Journal']['modified']; ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Html->link(__('Delete'), array('action' => 'delete', $journal['Journal']['id']), null, sprintf(__('Are you sure you want to delete # %s?'), $journal['Journal']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
