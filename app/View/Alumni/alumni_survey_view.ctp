        ...
        <div class="row">
            <div
                ...
                <div>
                    <div
                        class="smallheading">
                        <?php echo __('View Baseline Survey Questionnaire'); ?>
                    </div>
                    <div
                        onclick="toggleViewFullId('ListDepartment')"><?php
																		if (!empty($sections)) {
                    ...
                    <div id="ListDepartment"
                        style="display:<?php echo (!empty($sections) ? 'none' : 'display'); ?>">
                        <table
                            cellspacing="0"
                            cellpadding="0"
                            class="fs14">
                            <tr>
                                ...
                                <td><?php echo $this->Form->input('Search.gradution_academic_year', array(
										'id' => 'GradutionAcademicYear',
                            ...
                            <tr>
                                ...
                                <td><?php echo $this->Form->input('Search.program_id', array('id' => 'Program', 'class' => 'fs14', 'label' => false, 'type' => 'select', 'options' => $programs)); ?>
                                </td>
                                <td>Program
                                    Type:
                                </td>
                                <td><?php echo $this->Form->input('Search.program_type_id', array('id' => 'ProgramType', 'class' => 'fs14', 'label' => false, 'type' => 'select', 'options' => $programTypes)); ?>
                                </td>
                            </tr>
                            <tr>
                                <td>Name:
                                </td>
                                <td><?php echo $this->Form->input('Search.name', array('id' => 'name', 'class' => 'fs14', 'label' => false)); ?>
                                </td>
                                <td>Limit:
                                </td>
                                <td><?php echo $this->Form->input('Search.limit', array('id' => 'limit', 'class' => 'fs14', 'label' => false)); ?>
                                </td>
                    ...
                    <strong
                        style="color:red">Red:Not
                        graduated but
                        completed
                        survey</strong>
                    <br />
                    <strong
                        style="color:green">Green:Graduated
                        and completed
                        survey.</strong>
                    <table>
                        <tr>
                            <th
                                style="width:10%"><?php echo $this->Form->input(
															'select_all',
															array(
																'type' => 'checkbox', 'id' => 'select-all', 'div' => false,
																'label' => false
															)
														); ?>Select All</th>
                            <th
                        ...
                        <tr
                            ...
                            <td><?php
										...
										?></td>
                            <td><?php echo $student['Alumnus']['full_name']; ?>
                            </td>
                            <td><?php echo $student['Alumnus']['sex']; ?>
                            </td>
                    ...
                    <?php echo $this->Form->submit(__('Get  Alumni Questionnaire'), array(
							'name' => 'getAlumniQuestionnaireInExcel',
							'div' => false, 'class' => 'tiny radius button bg-blue'
						));
						echo '&nbsp;&nbsp;&nbsp;&nbsp;';
						echo $this->Form->submit(__('Delete Alumni Questionnaire Not Graduated'), array(
							'name' => 'deleteAlumniQuestionnaireInExcel',
							'div' => false, 'class' => 'tiny radius button bg-blue'
						));
						?>
