...
<p class="smallheading"><?php echo __('Course Schedule Cancellation'); ?> .</p>
<p class='fs16'>
...
<?php 
 if(!empty($section_course_schedule)) {
	echo '<table><tr><td>'.$this->Form->Submit('Cancel Schedule',array('name'=>'cancel','class'=>'tiny radius button bg-blue','div'=>false)).'</td></tr></table>';
