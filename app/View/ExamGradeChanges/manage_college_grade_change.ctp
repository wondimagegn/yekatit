	   ...
	   <td>
	    <?php 
	      ...
	      echo $this->Form->input('Mass.ExamGradeChange.'.$st_count.'.id', array('type' => 'hidden', 'value' => $grade_change['ExamGradeChange']['id']));
	       ...
	       echo $this->Form->input('Mass.ExamGradeChange.'.$st_count.'.college_approval', array('type' => 'hidden', 'value' =>1));
		...
		?>
				...
				<td style="vertical-align:top; width:60%">
					<table>
						...
						<tr>
							<td colspan="2"><?php echo $this->Form->Submit('Approve Grade Change Request',array('div'=>false,'class'=>'tiny radius button bg-blue', 'name'=>'approveGradeChangeByCollege_'.$st_count++)); ?></td>
						</tr>
					</table>
				</td>
			</tr>
