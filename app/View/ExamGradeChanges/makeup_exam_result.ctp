...
$(document).ready(function () {
	$("#ProgramID").change(function(){
		...
		$("#StudentSection").empty();
		$("#StudentSection").append('<option value="0">--- Select Section ---</option>');
		$("#Student").empty();
		...
		$("#ExamGrade").empty();
		$("#ExamGrade").append('<option value="0">--- Select Grade ---</option>');
		$("#PreviousGarde").empty();
		$("#PreviousGarde").append('---');
		disableEnale(true);
...
<div class="smallheading"><?php echo __('Record Supplementary Exam Result &amp; Grade'); ?></div>
<div class="info-box info-message"><span></span>After you submite the supplementary exam grade result, it will be on pending state till it get approved by the registrar. You can also enter a remark that will be visible to the registrar.</div>
<table class="fs14">
	<tr>
	...
	<tr>
		<td>Student taking the supplementary exam</td>
	...
	<tr>
		<td>Exam Result</td>
		<td><?php echo $this->Form->input('makeup_exam_result', array('id' => 'MakeupExamResult', 'label' => false, 'style' => 'width:100px')) ?></td>
	</tr>
	<tr>
		<td>Exam Grade</td>
		<td id="ExamGrade1"><?php echo $this->Form->input('grade', array('id' => 'ExamGrade', 'label' => false, 'type' => 'select', 'options' => $exam_grades, 'default' => $grade)) ?></td>
	</tr>
	<tr>
		<td>Remark</td>
		<td><?php echo $this->Form->input('reason', array('label' => false, 'type' => 'textarea', 'cols' => 40, 'rows' => 5)); ?></td>
	</tr>
</table>
<?php echo $this->Form->end(__('Add Supplementary Exam'));?>
</div>
