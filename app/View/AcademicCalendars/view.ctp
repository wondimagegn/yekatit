            ...
            <div
                                        ...
                                        <dd<?php if ($i++ % 2 == 0) echo $class; ?>>
                                            ...
                                            <dt<?php if ($i % 2 == 0) echo $class; ?>>
                                                ...
                                                <dd<?php if ($i++ % 2 == 0) echo $class; ?>>
                                                    ...
                                                    <dt<?php if ($i % 2 == 0) echo $class; ?>>
                                                        <?php echo __('Course Registration Start Date'); ?>
                                                        </dt>
                                                        <dd<?php if ($i++ % 2 == 0) echo $class; ?>>
                                                            ...
                                                            <dt<?php if ($i % 2 == 0) echo $class; ?>>
                                                                <?php echo __('Course Registration End Date'); ?>
                                                                </dt>
                                                                <dd<?php if ($i++ % 2 == 0) echo $class; ?>>
                                                                    ...
                                                                    <dt<?php if ($i % 2 == 0) echo $class; ?>>
                                                                        <?php echo __('Course Add Start Date'); ?>
                                                                        </dt>
                                                                        <dd<?php if ($i++ % 2 == 0) echo $class; ?>>
                                                                            ...
                                                                            <dt<?php if ($i % 2 == 0) echo $class; ?>>
                                                                                <?php echo __('Course Add End Date'); ?>
                                                                                </dt>
                                                                                <dd<?php if ($i++ % 2 == 0) echo $class; ?>>
                                                                                    ...
                                                                                    <dt<?php if ($i % 2 == 0) echo $class; ?>>
                                                                                        <?php echo __('Course Drop Start Date'); ?>
                                                                                        </dt>
                                                                                        <dd<?php if ($i++ % 2 == 0) echo $class; ?>>
                                                                                            ...
                                                                                            <dt<?php if ($i % 2 == 0) echo $class; ?>>
                                                                                                <?php echo __('Course Drop End Date'); ?>
                                                                                                </dt>
                                                                                                <dd<?php if ($i++ % 2 == 0) echo $class; ?>>
                                                                                                    ...
                                                                                                    <dt<?php if ($i % 2 == 0) echo $class; ?>>
                                                                                                        <?php echo __('Grade Submission Start Date'); ?>
                                                                                                        </dt>
                                                                                                        <dd<?php if ($i++ % 2 == 0) echo $class; ?>>
                                                                                                            ...
                                                                                                            <dt<?php if ($i % 2 == 0) echo $class; ?>>
                                                                                                                <?php echo __('Grade Submission End Date'); ?>
                                                                                                                </dt>
                                                                                                                <dd<?php if ($i++ % 2 == 0) echo $class; ?>>
                                                                                                                    ...
                                                                                                                    <dt<?php if ($i % 2 == 0) echo $class; ?>>
                                                                                                                        <?php echo __('Fx Grade Submission End Date'); ?>
                                                                                                                        </dt>
                                                                                                                        <dd<?php if ($i++ % 2 == 0) echo $class; ?>>
                                                                                                                            ...
                                                                                                                            <dt<?php if ($i % 2 == 0) echo $class; ?>>
                                                                                                                                <?php echo __('Senate Meeting Date'); ?>
                                                                                                                                </dt>
                                                                                                                                <dd<?php if ($i++ % 2 == 0) echo $class; ?>>
                                                                                                                                    ...
                                                                                                                                    <dt<?php if ($i % 2 == 0) echo $class; ?>>
                                                                                                                                        ...
                                                                                                                                        <dd<?php if ($i++ % 2 == 0) echo $class; ?>>
                                                                                                                                            ...
                                                                                                                                            <dt<?php if ($i % 2 == 0) echo $class; ?>>
                                                                                                                                                <?php echo __('Online Admission Start Date'); ?>
                                                                                                                                                </dt>
                                                                                                                                                <dd<?php if ($i++ % 2 == 0) echo $class; ?>>
                                                                                                                                                    ...
                                                                                                                                                    <dt<?php if ($i % 2 == 0) echo $class; ?>>
                                                                                                                                                        <?php echo __('Online Admission End Date'); ?>
                                                                                                                                                        </dt>
                                                                                                                                                        <dd<?php if ($i++ % 2 == 0) echo $class; ?>>
                ...
                <dl
                    ...
                    <dt>
                        <div
                            class="smallheading">
                            <?php echo __('Department and field of study which has this calendar'); ?>
                        </div>
                    </dt>
                    <?php
					echo "<ul>";
