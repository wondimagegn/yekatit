...
<?php echo $this->Form->create('StaffStudy'); ?>
	<fieldset>
		<legend><?php echo __('Edit Staff Study'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('StaffStudy.id')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('StaffStudy.id')))); ?></li>
