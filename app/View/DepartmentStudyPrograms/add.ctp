			...
			<div class="large-12 columns">
                ...
                <fieldset style="margin-top: 5px; padding-bottom: 5px;padding-top: 25px;">
					...
					<div class="row">
						<div class="large-12 columns">
							<hr>
							<?= $this->Form->end(array('label' => 'Add Study Program', 'name' => 'addStudyProgram', 'id' => 'addStudyProgram', 'class' => 'tiny radius button bg-blue')); ?>
						</div>
					</div>
				</fieldset>
			</div>
...
<script>
    ...
    $(function() {
		...
		const $submitBtn = $('#addStudyProgram');
		...
		$form.on('submit', function (e) {
			...
			$submitBtn.val('Adding Study Program...');
