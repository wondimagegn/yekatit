        ...
        <div class="row">
            <div
                ...
                <div
                    ...
                    <div
                        class="smallheading">
                        <?php echo __('Placement Report View ');?>
                    </div>
                    ...
                    <table
                        ...
                        <tr>
                            ...
                            <td
                                style="width:20%">
                                <?php echo $this->Form->input('Search.academic_year',array('options'=>$acyear_array_data,'empty'=>'--select academic year--','required'=>true,'id'=>'AcademicYear',s
'onchange'=>'updateCourseListOnChangeofOtherField()','label'=>false)); ?>
                            </td>
                            <td
                                style="width:15%">
                                Department:
                            ...
                            <td
                                style="width:50%">
                                <?php echo $this->Form->input('Search.department_id',
...
'id'=>'DepartmentId','label'=>false)); ?></td>
                        ...
                        <tr>
                            ...
                            <td
                                style="width:20%">
                                <?php echo $this->Form->input('Search.result_criteria_id',
array('id'=>'PlacementResultCriteria','label'=>false)); ?>
                            </td>
                            <td
                                style="width:15%">
                                Gender:
                            ...
                            <td
                                style="width:20%">
                                <?php echo $this->Form->input('Search.sex',
array('options'=>array('all'=>'All','male'=>'Male','female'=>'Female'),'label'=>false)); ?>
                            </td>
                        ...
                        <tr>
                            ...
                            <td
                                style="width:20%">
                                <?php echo $this->Form->input('Search.placement_based',
array('options'=>array('all'=>'All','C'=>'Competitive','Q'=>'Quota'),'label'=>false));  ?>
                            ...
                            <td
                                style="width:20%">
                                <?php echo $this->Form->input('Search.placementtype',
...
?>
                    <table>
                        ...
                        <tr>
                            ...
                            <th><?php echo ('Pre Result');?>
                            </th>
                            <th><?php echo ('Preference Order');?>
                            </th>
                            <th><?php echo ('Field');?>
                            </th>
                            <th><?php echo ('Academic Year');?>
                            </th>
                            <th><?php echo ('Field approval');?>
                            </th>
                            <th><?php echo ('Placement Type ');?>
                            </th>
                            <th><?php echo ('Placement Based');?>
                            </th>
	...
	?>
                        <tr<?php echo $class;?>>
                            ...
                            <td><?php echo $acceptedStudent['AcceptedStudent']['freshman_result']; ?>&nbsp;
                            </td>
                            <td><?php
		...
		?>&nbsp;</td>
                            ...
                            <td><?php echo isset($acceptedStudent['AcceptedStudent']['approval']) ? 'Yes':'No'; ?>&nbsp;
                            </td>

                            <td><?php echo $acceptedStudent['AcceptedStudent']['placementtype']; ?>&nbsp;
                            </td>
                            <td><?php echo $acceptedStudent['AcceptedStudent']['placement_based'] == 'C' ? 'Competitive' : 'Quota'; ?>&nbsp;
                            </td>
                            </tr>
                            <?php endforeach; ?>
                    </table>
...
function updateCourseListOnChangeofOtherField() {
    ...
    var formUrl =
        '/participatingDepartments/getParticipatingDepartment/' +
        formData;
    $.ajax({
        type: 'get',
        url: formUrl,
    ...
    var formUrl =
        '/placementsResultsCriterias/getPlacementResultCriteria/' +
        formData;
    $.ajax({
        type: 'get',
        url: formUrl,
