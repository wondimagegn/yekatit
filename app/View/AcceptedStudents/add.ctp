        ...
        <div class="row">
            <div
                ...
                <div
					...
					echo '<tr><td> Gender' . $this->Form->input('sex', array('options' => $options, 'type' => 'radio', 'legend' => false, 'label' => '', 'separator' => '', 'label' => false)) . '</td></tr>';
					...
					echo '<tr><td>' . $this->Form->input('college_id', array(
						'label' => 'Department', 'id' => 'CollegeID', 'empty' => '--select department--',
						'style' => 'width:200px'
					)) . '</td></tr>';
					echo '<tr><td>' . $this->Form->input('department_id', array('empty' => "No field of study", 'id' => 'DepartmentID', 'style' => 'width:200px')) . '</td></tr>';
