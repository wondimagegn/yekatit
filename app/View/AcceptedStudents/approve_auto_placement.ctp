                                ...
                                <td
                                    ...
                                    <table>
                                        <tr>
                                            <th colspan=12
                                                class="smallheading">
                                                <?php echo  __('List of students placed to ' . $department_name . ' by the department  with minute number ' . $minute_number . ' and  who
   are not attached to the curriculum by the field of study coordinator.', true); ?>
                                            </th>
                                        </tr>
                                        <tr>
                    ...
                    <?php
										if (!isset($turn_of_approve_button)) {
											...
											echo "</tr>";
											echo '<tr><td colspan=2>' . $this->Form->Submit(__('Attached Selected Student'), array(
												'div' => false,
												'name' => 'approve'
											)) . '</td></tr>';
											echo "</table>";
