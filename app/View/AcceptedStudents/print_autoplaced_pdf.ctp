    ...
    if(!empty($autoplacedstudents)){
          ...
          unset($autoplacedstudents['auto_summery']);
           foreach($autoplacedstudents as $key =>$data){
                ...
                $department_placement .= '<tr><th style="border: 1px solid #000000; width:50px;font-weight:bold;">No.</th><th style="border: 1px solid #000000; width: 200px;font-weight:bold;">Full Name</th><th style="border: 1px solid #000000; width: 40px;font-weight:bold;">Sex</th><th style="border: 1px solid #000000; width: 80px;font-weight:bold;">Student Number</th><th style="border: 1px solid #000000; width: 70px;font-weight:bold;">EHEECE Total Result</th><th style="border: 1px solid #000000; width: 80px;font-weight:bold;">Field of study</th>
