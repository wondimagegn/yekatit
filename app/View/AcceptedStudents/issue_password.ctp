    ...
    <div class="box-body">
        <div class="row">
            <div
                ...
                <h3><?php echo __('Password issue/reset  to a student'); ?>
                </h3>
        ...
        ?>
                <div
                    ...
                    ?>
                            ...
                            <tr>
                                <td><?php echo $this->Form->Submit('Continue', array('div' => false, 'name' => 'issuestudentidsearch')); ?>
                                </td>
                            </tr>
                        </tbody>
                    </table>
          ...
          ?>
                    <table>
                        <tr>
                            <td
                                ...
                                Student
                                Name:
                                <?php echo $students['AcceptedStudent']['full_name'] ?>
                            </td>
                        </tr>
                        <tr>
                            <td
                                style="font-weight:bold">
                                Department:
                                <?php echo $students['College']['name'] ?>
                            </td>
                        </tr>
                        <tr>
                            <td><?php
                    ...
                    echo $this->Form->input('User.username', array('value' => $students['AcceptedStudent']['studentnumber'], 'readonly' => 'readonly'));  ?>
                            </td>
                        </tr>
                        <tr>
                            <td><?php echo $this->Form->input('User.passwd', array('label' => 'Password', 'type' => 'password', 'id' => 'password'));  ?>
                            </td>
                        </tr>
                        <tr>
                      ...
                      array('id' => 'text', 'name' => 'text')
                        ...
                        <!-- <tr> <td> <table><tr><td><input type="button" id="button_generate_password" value="Generate" onclick="suggestPassword(this.form)"></td><td><?php echo $this->Form->input(
                                                                                                                                                                'Generate Password',
                                                                                                                                                                array('id' => 'text', 'name' => 'text')
                                                                                                                                                              );  ?></td></tr></table></tr> -->

                        <tr>
                            <td><?php echo $this->Form->Submit('Set Password', array(
                      'div' => false,
