...
function getPlacementSummery() {
    ...
    $("#academicyear").attr('disabled',
        true);
    $("#runautoplacementbutton").attr(
        'disabled', true);

    $("#summery_student_result_category")
        .empty().
    html(
        ...
        <div class="row">
            <div
                ...
                <div
                    ...
                    <td width="90%"
                        id="summery_student_result_category">
                    ...
                    <tr>
                        <td colspan=3>
							...
							if (!isset($auto_already_run)) {
								echo $this->Form->Submit(__('Run Auto Placement'), array(
									'div' => false, 'name' => 'runautoplacement',
                    ...
                    <tr>
                        <td colspan=2>
							...
							if (!empty($autoplacedstudents)) {
								...
								echo "<table><tbody><tr><td>" . $this->Html->link(
									$this->Html->image("pdf_icon.gif", array("alt" => "Print to PDF")),
									array('action' => "print_autoplaced_pdf"),
									array('escape' => false)
								) . " Print</td><td>" . $this->Html->link($this->Html->image("xls-icon.gif", array('alt' => 'Export To Xls')), array('action' => "export_autoplaced_xls"), array('escape' => false)) . " Export</td></tr></tbody></table>";
								echo "<table><tbody>";
								echo "<tr><th colspan=3> Summery of Auto Placement.</th></tr>";
								echo "<tr><th>Field</th><th>Competitive Assignment</th><th> Privilaged Quota Assignment</th>";
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <th><?php echo ('Assignment Type'); ?>
                                    </th>
                                    <th><?php echo ('EHEECE Total Result'); ?>
                                    </th>
                                ...
                                <tr<?php echo $class; ?>>
                                    ...
                                    <td><?php echo $acceptedStudent['AcceptedStudent']['assignment_type']; ?>&nbsp;
                                    </td>
                                    ...
                                    <td><?php echo isset($acceptedStudent['AcceptedStudent']['approval']) ? 'Approved By Department' : 'Not Approved By Department'; ?>&nbsp;
                                    </td>
