...
<div class="box">
	...
	<?php
		...
		echo $this->Form->input('amharic_name',
		array('style' => 'width:300px', 'id'=>'AmharicText','onkeypress'=>"return AmharicPhoneticKeyPress(event,this);"));
		echo $this->Form->input('amharic_short_name',
