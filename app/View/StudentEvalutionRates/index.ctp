<div class="studentEvalutionRates index">
	<h2><?php echo __('Student Evalution Rates'); ?></h2>
	...
	<tr>
		<td><?php echo h($studentEvalutionRate['StudentEvalutionRate']['id']); ?>&nbsp;</td>
		<td>
		...
		<td><?php echo h($studentEvalutionRate['StudentEvalutionRate']['rating']); ?>&nbsp;</td>
		<td><?php echo h($studentEvalutionRate['StudentEvalutionRate']['created']); ?>&nbsp;</td>
		<td><?php echo h($studentEvalutionRate['StudentEvalutionRate']['modified']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $studentEvalutionRate['StudentEvalutionRate']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $studentEvalutionRate['StudentEvalutionRate']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $studentEvalutionRate['StudentEvalutionRate']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $studentEvalutionRate['StudentEvalutionRate']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
