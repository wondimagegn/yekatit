	...
	*/
	...
	public function add_student_to_section($student_id)
	{
        ...
        if (!empty($student_detail['Student']['department_id'])) {
            $yearLevels = $this->Section->YearLevel->find('first', array('conditions' =>
                array('YearLevel.department_id' => $student_detail['Student']['department_id'],
                    'YearLevel.name ' => $yearLevels
                    )));
            $yearLevels = $this->Section->YearLevel->find('list', array('conditions' =>
                array('YearLevel.department_id' => $student_detail['Student']['department_id'],
                    'YearLevel.id >= ' => $yearLevels['YearLevel']['id']
                ),
