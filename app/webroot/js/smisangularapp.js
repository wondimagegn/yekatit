...
dashboardApp.controller('gradeApprovalConfirmation',['$scope','$http','$filter','$timeout',
	'removeLoading','numberOfPageService',function($scope,$http,$filter,$timeout,removeLoading,numberOfPageService) 
{
...
/*
dashboardApp.controller('deptGradeApprovalController',['$scope','$http','$filter','$timeout',
	'removeLoading','numberOfPageService',function($scope,$http,$filter,$timeout,removeLoading,numberOfPageService) 
{
	...
	$scope.getApprovalRejectGradee=function() {  $http({
		method : "GET",
		url : "/dashboard/getApprovalRejectGrade.json"
	}).then(
	    	function mySucces(response) {
...
dashboardApp.controller('freshmanGradeApprovalController',['$scope','$http','$filter','$timeout',
	'removeLoading','numberOfPageService',function($scope,$http,$filter,$timeout,removeLoading,numberOfPageService) 
{
        $scope.currentPage = 0;
	$scope.pageSize = 1;
	...
	$scope.getApprovalRejectGradeF=function() { $http({
		method : "GET",
		url : "/dashboard/getApprovalRejectGrade.json"
	    }).then(
	    	function mySucces(response) {
...
*/
dashboardApp.controller('gradeChangeController',['$scope','$http','$filter','removeLoading', function($scope, $http,$filter,removeLoading) {
...
dashboardApp.controller('messageController',['$scope','$http','$filter',
	'$timeout','removeLoading','$sce',
...
dashboardApp.controller('studentRankController',['$scope','$http',
	'removeLoading', function($scope, $http,removeLoading) {
...
dashboardApp.controller('studentDormDashBoardController',['$scope','$http','removeLoading', function($scope, $http,removeLoading) {	 
...
function($scope,$http,$filter,$timeout,removeLoading,numberOfPageService) {
   ...
   $scope.disptachedAssignedCourse=function() { $http({
     method : "GET",
...
function($scope,$http,$filter,$timeout,removeLoading) {
    ...
    $scope.clearanceWithdrawSubRequestC=function() { $http({
     method : "GET",
...
function($scope,$http,$filter,$timeout,removeLoading) {
    ...
    $scope.addDropRequestListC=function() { $http({
     method : "GET",
...
function($scope,$http,$filter,$timeout,removeLoading) {
    ...
    $scope.getBackupAccountRequestB=function(){ $http({
     method : "GET",
...
function($scope,$http,$filter,$timeout,removeLoading) {
    ...
    $scope.getProfileNotCompleteP=function(){ $http({
     method : "GET",
